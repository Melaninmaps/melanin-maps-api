# OPS-SURGICAL-CHANGE-001 — Surgical Implementation and Independent Verification Standard
...
This file lives at `docs/operations/OPS-SURGICAL-CHANGE-001.md` and is referenced from `docs/README.md`. It must be preserved in project-level engineering instructions and referenced in every pull request/task completion summary.
...
*Added to permanent register: 2026-08-13. Source: Broad Production Audit — 2026-08-13.*
