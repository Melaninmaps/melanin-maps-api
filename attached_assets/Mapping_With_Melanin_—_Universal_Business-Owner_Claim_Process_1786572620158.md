...
**Launch rule:** A traveler should be able to meet a business owner on tour, invite that owner to join Mapping With Melanin, find the existing business listing, submit a claim, and receive owner access only after a safe review. If the business is missing, the owner must be offered a real listing-submission path; the system must never fabricate a record to make the claim button work.
...
| Official URL and/or verified social handle | At least one unless submitting evidence through secure storage. |
...
| Business owner workspace | Appear only after verified approval, never immediately after form submission. |
