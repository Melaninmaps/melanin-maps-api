...
| Employment / career / skills / housing / business | 2, with at least 1 government, recognized professional body, or official program source |
...
3. Use sources suited to the topic’s consequence level:
   ...
   - Housing: HUD, fair-housing agencies, state/local housing agencies, recognized tenant/legal-aid organizations.
...
Seed the remaining business, community, digital, entertainment, lifestyle, skills/trades, and related topics under the same canonical-source and direct-mapping rules.
