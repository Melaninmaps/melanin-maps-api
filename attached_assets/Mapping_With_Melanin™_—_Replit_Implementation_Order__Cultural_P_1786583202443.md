...
**Resolution threshold:** `resolved` only when top score is at least `1200` and exceeds the next eligible candidate by `250`. Otherwise return `needs_clarification` with 2–3 source-backed choices. If no eligible candidate exists, return `unconfirmed`.
...
Show: **“Member-shared link · Source review pending.”** Do not call it verified.
...
6. CK-01–CK-14, WH-01–WH-10, SM-01–SM-10, and PR-01–PR-05 test output.
