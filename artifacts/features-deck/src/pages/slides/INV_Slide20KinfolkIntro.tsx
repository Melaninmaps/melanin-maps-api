  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden flex items-center justify-center" style={{ background: "#3D2417" }}>
      ...
      <div className="text-center px-[8vw]">
        ...
        <div className="font-display leading-tight mt-[0.56vw]" style={{ fontSize: "6.2vw", fontWeight: 700, color: "#CA922B" }}>
          Your business partner.
        </div>
        <div className="font-body mt-[2vw]" style={{ fontSize: "1.4vw", color: "#D8B98A", fontWeight: 400 }}>
