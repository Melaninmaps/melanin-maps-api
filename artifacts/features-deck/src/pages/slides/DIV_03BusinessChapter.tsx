export default function DIV03BusinessChapter() {
  return (
    <div
      className="relative w-screen h-screen overflow-hidden"
      style={{ background: "radial-gradient(ellipse at 35% 62%, rgba(82,35,5,0.48) 0%, #1C0E06 48%, #100804 100%)" }}
    >
      ...
      <div className="absolute left-0 right-0 flex flex-col items-center justify-center" style={{ top: "12%", bottom: "12%" }}>
        ...
        <p
          ...
          style={{ fontSize: "1.55vw", color: "#A07840", fontWeight: 300, lineHeight: 1.7, maxWidth: "48vw" }}
        >
          Every feature. Every story. The full product experience.
        </p>
