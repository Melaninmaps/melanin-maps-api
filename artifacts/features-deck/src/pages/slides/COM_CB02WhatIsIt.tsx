const connectionLabels = [
  "Businesses", "Safety", "Heritage", "Friends",
  "Neighborhoods", "Kinfolk AI", "Local Knowledge",
];
    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#3D2417" }}>
      ...
      <div className="absolute flex flex-col justify-center" style={{ left: "7vw", top: "10%", bottom: "10%", width: "42vw" }}>
        ...
        <h1 className="font-display" style={{ fontSize: "4.4vw", fontWeight: 800, color: "#FAF6EF", lineHeight: 1.1, marginBottom: "2.4vw" }}>
          One platform.<br />Every part of<br /><span style={{ color: "#CA922B" }}>belonging.</span>
        </h1>
        ...
        <p className="font-body" style={{ fontSize: "1.2vw", color: "#C4935A", lineHeight: 1.75, fontWeight: 300 }}>
          Mapping With Melanin&trade; brings together the people, businesses, cultural heritage,
          community safety, and trusted recommendations that help someone feel connected &mdash;
          whether they&rsquo;re exploring a new city or deepening roots where they already live.
        </p>
      </div>
      ...
      <div className="absolute flex items-center justify-center" style={{ right: "6vw", top: "8%", bottom: "8%", width: "36vw" }}>
        <div className="flex flex-col items-center w-full">
          <div style={{ padding: "0.85vw 0", width: "100%", textAlign: "center", border: "1px solid rgba(202,146,43,0.28)", background: "rgba(250,246,239,0.04)" }}>
            <span className="font-display" style={{ fontSize: "2vw", fontWeight: 700, color: "#FAF6EF" }}>People</span>
          </div>

          <Arrow />

          <div style={{ width: "100%", border: "1px solid rgba(202,146,43,0.45)", background: "rgba(202,146,43,0.06)", padding: "0.9vw 1.4vw" }}>
            ...
            <div className="flex flex-wrap justify-center" style={{ gap: "0.35vw 0.55vw" }}>
              {connectionLabels.map((label) => (
                <span key={label} className="font-body" style={{ fontSize: "0.75vw", color: "#CA922B", letterSpacing: "0.06em", fontWeight: 500, padding: "0.18vw 0.55vw", border: "1px solid rgba(202,146,43,0.3)", background: "rgba(202,146,43,0.06)" }}>
                  {label}
                </span>
              ))}
            </div>
          ...
          <div style={{ padding: "0.9vw 0", width: "100%", textAlign: "center", border: "1.5px solid #CA922B", background: "rgba(202,146,43,0.11)" }}>
