export default function DIV01ExperienceChapter() {
  return (
    <div
      className="relative w-screen h-screen overflow-hidden"
      style={{ background: "radial-gradient(ellipse at 28% 45%, rgba(82,35,5,0.50) 0%, #1C0E06 48%, #100804 100%)" }}
    >
      ...
      <div className="absolute left-0 right-0 flex flex-col items-center justify-center" style={{ top: "12%", bottom: "12%" }}>
        ...
        >
          Never wonder if you&rsquo;ll feel welcome again.
        </p>
