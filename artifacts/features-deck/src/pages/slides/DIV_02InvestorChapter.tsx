export default function DIV02InvestorChapter() {
  return (
    <div
      className="relative w-screen h-screen overflow-hidden"
      style={{ background: "radial-gradient(ellipse at 72% 38%, rgba(82,35,5,0.42) 0%, #1C0E06 48%, #100804 100%)" }}
    >
      ...
      <div className="absolute left-0 right-0 flex flex-col items-center justify-center" style={{ top: "12%", bottom: "12%" }}>
        ...
        >
          No one should have to wonder if they&rsquo;ll feel welcome.
        </p>
