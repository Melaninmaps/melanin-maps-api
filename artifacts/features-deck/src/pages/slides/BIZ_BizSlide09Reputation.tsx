export default function BizSlide09Reputation() {
  const chain = [
    {
      label: "Verified Badge",
      body: "Community-confirmed. Instantly signals legitimacy and trust.",
      icon: <><path d="M12 22s8-4 8-10V5l-8-2-8 2v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></>,
    },
    {
      label: "Recommendations",
      body: "Your customers become your best marketing channel.",
      icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></>,
    },
    {
      label: "Trust Score",
      body: "A live, compounding metric that grows with every positive interaction.",
      icon: <><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></>,
    },
    {
      label: "Search Ranking",
      body: "Higher trust means more visibility in every community search.",
      icon: <><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></>,
    },
    {
      label: "Customer Loyalty",
      body: "Repeat visits, saves, and community advocacy build on each other.",
      icon: <><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></>,
    },
    {
      label: "Word of Mouth",
      body: "The most powerful advertising channel — and it costs you nothing.",
      ...
      <div className="absolute" style={{ left: "6vw", right: "6vw", top: "17vw", bottom: "5.5vw", display: "flex", flexDirection: "row", alignItems: "stretch", gap: "0" }}>
        {chain.map((step, i) => (
          <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", position: "relative" }}>
            ...
            {i < chain.length - 1 && (
              <div style={{ position: "absolute", right: "-1px", top: "2.8vw", zIndex: 2, display: "flex", alignItems: "center" }}>
                <svg width="1.4vw" height="1.4vw" viewBox="0 0 24 24" fill="none" stroke="#CA922B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ width: "100%", background: i % 2 === 0 ? "#FFFFFF" : "#F5EBD8", borderRadius: "0.8vw", padding: "1.3vw 1.1vw", border: `1px solid ${i === 0 ? "#CA922B" : "rgba(58,31,14,0.08)"}`, borderLeft: i === 0 ? "3px solid #CA922B" : undefined, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", height: "100%" }}>
              <div style={{ width: "2.8vw", height: "2.8vw", borderRadius: "50%", background: i === 0 ? "#CA922B" : "rgba(202,146,43,0.12)", border: `1px solid ${i === 0 ? "transparent" : "rgba(202,146,43,0.3)"}`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "0.8vw", flexShrink: 0 }}>
                <svg width="1.2vw" height="1.2vw" viewBox="0 0 24 24" fill="none" stroke={i === 0 ? "#1C0E06" : "#CA922B"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  {step.icon}
                </svg>
              </div>
