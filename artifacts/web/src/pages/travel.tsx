                  ...
                  <div id="kinfolk-composer-controls" className="mx-auto mb-3 max-w-3xl rounded-2xl border border-[#3A1F0E]/8 bg-[#FAF6EF] p-3">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {([[
                        ...
                        <button key={value} onClick={() => setKinfolkMode(value)} className={`rounded-full px-3 py-1.5 text-[11px] font-bold transition-colors ${kinfolkMode === value ? "bg-[#2B1507] text-white" : "border border-[#3A1F0E]/10 bg-white text-[#3A1F0E]/55 hover:border-[#CA922B]/35 hover:text-[#8D5C17]"}`}>{label}</button>
                      ))}
                    </div>
