...
const FAQ_ITEMS = [
  ...
  { q: "How do businesses become verified?", a: "All Black-owned businesses are welcome to join Mapping With Melanin — we understand that every business is at a different stage in its journey, and that's okay. Any Black-owned business can list on our platform. Businesses that want to take it a step further can apply for our special Verified Badge through our Business Verification program. We review documentation confirming ownership and business legitimacy before awarding verified status — it's an extra layer of trust, not a barrier to entry." },
