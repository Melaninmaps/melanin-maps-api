...
const CITY_DATA: Record<string, {
  ...
  atlanta: {
    name: "Atlanta", state: "GA", tagline: "The Minority Mecca of the South", emoji: "🍑",
    image: "https://images.unsplash.com/photo-1575917649705-5b59aaa12e6b?w=1400&auto=format&fit=crop",
    searchTerm: "Atlanta",
    description: "Atlanta has long been America's Minority cultural capital — home to more Minority millionaires, Minority-owned businesses, and HBCUs than almost any other city. From the birthplace of Dr. King to today's booming creative and tech economy, ATL is where Minority excellence is not the exception, but the standard.",
    safetyScore: 78,
    culture: "Atlanta's culture blends Southern hospitality with urban ambition. The city's historically Minority neighborhoods — Sweet Auburn, Pittsburgh, and West End — are experiencing a renaissance of community investment.",
    neighborhoods: [
  ...
  houston: {
    ...
    searchTerm: "Houston",
    description: "The most diverse city in America, Houston's Third Ward has been the heart of Minority Houston for generations. With a thriving Creole food scene, strong HBCUs, and a booming business community, Houston rewards explorers who venture off the beaten path.",
    safetyScore: 74,
    culture: "Houston's Minority culture blends Southern tradition with Gulf Coast flavor. The city's Creole heritage creates unique food, music, and cultural expressions found nowhere else.",
    neighborhoods: [
  ...
  "new-orleans": {
    name: "New Orleans", state: "LA", tagline: "Birthplace of Jazz, Heart of Minority Culture", emoji: "🎷",
    image: "https://images.unsplash.com/photo-1568458730946-c04e9fb7d04e?w=1400&auto=format&fit=crop",
    searchTerm: "New Orleans",
    description: "New Orleans is unlike anywhere in America. The oldest African American urban culture in the country, Creole heritage that blends African, French, and Caribbean traditions, and a music scene that birthed jazz — NOLA is a living, breathing testament to Minority cultural genius.",
    safetyScore: 71,
    culture: "Creole culture, second lines, Mardi Gras Indians — New Orleans' Minority cultural traditions have no parallel. The Tremé neighborhood is the oldest African American neighborhood in the United States.",
    neighborhoods: [
      { name: "Tremé", vibe: "Oldest Minority neighborhood in the US", score: 76 },
  ...
  "washington-dc": {
    ...
    description: "DC has been 'Chocolate City' for generations — a center of Minority political power, intellectual life, and cultural expression. From the Smithsonian's National Museum of African American History and Culture to the U Street Corridor's rich music history, DC rewards every visit.",
    safetyScore: 80,
    culture: "DC's Minority professional class, political history, and museum culture create a uniquely sophisticated atmosphere. Howard University anchors an entire ecosystem of Minority excellence.",
    neighborhoods: [
  ...
  "new-york": {
    name: "New York", state: "NY", tagline: "Harlem to Brooklyn — Minority Excellence Everywhere", emoji: "🗽",
    image: "https://images.unsplash.com/photo-1490644658840-3f2e3f8c5625?w=1400&auto=format&fit=crop",
    searchTerm: "New York",
    description: "New York's Minority communities have shaped global culture for over a century. Harlem's Renaissance, Brooklyn's creative explosion, the Bronx's hip-hop birthplace — NYC has more Minority history per block than almost any city on Earth.",
    safetyScore: 82,
    culture: "From the Harlem Renaissance to Brooklyn hip-hop, NYC's Minority cultural contributions are foundational to American and global culture. The sheer density of Minority creative, business, and intellectual life here is unmatched.",
    neighborhoods: [
      { name: "Harlem", vibe: "Historic capital of Minority America", score: 82 },
      { name: "Bed-Stuy", vibe: "Brooklyn's creative Minority hub", score: 81 },
      { name: "Crown Heights", vibe: "Caribbean culture + community", score: 79 },
      { name: "South Bronx", vibe: "Hip-hop birthplace", score: 76 },
    ],
    mustVisit: [
      { icon: Utensils, label: "Harlem restaurant row", description: "Soul food, Caribbean, and global Minority cuisine" },
    ...
    travelTips: [
      ...
      "Check local event listings — there's always a Minority cultural event happening",
    ],
  },
  chicago: {
    ...
    searchTerm: "Chicago",
    description: "Chicago's South Side is one of the most historically significant Minority communities in America. Bronzeville — the 'Black Metropolis' — was once the most important Minority urban center outside New York. Today, the city's deep blues and house music heritage, incredible cuisine, and strong business community make it essential.",
    safetyScore: 73,
    culture: "Chicago gave the world the electric blues, house music, and a distinct South Side culture that's shaped everything from fashion to food. The city's Minority community has always been a force of cultural innovation.",
    neighborhoods: [
