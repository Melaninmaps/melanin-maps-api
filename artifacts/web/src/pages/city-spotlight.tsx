...
const CITY_DATA: Record<string, {
  ...
  atlanta: {
    ...
    searchTerm: "Atlanta",
    description: "Atlanta has long been America's cultural capital for the melanated diaspora — home to more Black millionaires, minority-owned businesses, and HBCUs than almost any other city. From the birthplace of Dr. King to today's booming creative and tech economy, ATL is where Black excellence is not the exception, but the standard.",
    safetyScore: 78,
