      ...
      <div className="max-w-3xl mx-auto px-4 py-16 space-y-10 text-[#3A1F0E]">
        ...
        <section>
          ...
          <div className="bg-white border border-[#2B1507]/10 rounded-2xl p-6 space-y-1 text-sm text-[#3A1F0E]/80">
            <p>Email: <a href="mailto:hello@mappingwithmelanin.com?subject=Community%20Guidelines%20Report" className="text-[#CA922B] underline">hello@mappingwithmelanin.com</a></p>
