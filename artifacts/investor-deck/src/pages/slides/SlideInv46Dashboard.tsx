export default function SlideInv46Dashboard() {
  const metrics = [
    ...
    { label: "Search Trends", value: "#1", delta: "in Soul Food · Philly", up: true, icon: <><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></> },
    ...
    { label: "Community Feedback", value: "4.9", delta: "214 verified reviews", up: true, icon: <><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></> },
