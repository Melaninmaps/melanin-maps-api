...
export default function Slide26NetworkEffect() {
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#3D2417" }}>
      ...
      <div className="absolute bottom-[1.7vw] right-[5vw] font-display" style={{ fontSize: "2vw", color: "#CA922B", fontWeight: 700, opacity: 0.35 }}>27</div>

      <div className="absolute left-0 right-0 text-center px-[8vw]" style={{ top: "4.5vw" }}>
      ...
      <div className="absolute left-0 right-0 flex justify-center" style={{ top: "16.9vw" }}>
          ...
          {COLS.map((col) => (
            <div key={col.input} className="flex flex-col items-center text-center">
              <div
                ...
                style={{ width: "3vw", height: "3vw", border: "2px solid rgba(202,146,43,0.7)", marginBottom: "0.9vw" }}
              >
                <div className="font-display" style={{ fontSize: "1.6vw", color: "#CA922B", fontWeight: 700 }}>+</div>
              </div>
              <div className="font-display mb-[0.9vw]" style={{ fontSize: "1.25vw", fontWeight: 700, color: "#F5EBD8" }}>
                {col.input}
              </div>
              <div className="font-display mb-[0.9vw]" style={{ fontSize: "1.4vw", color: "#CA922B", opacity: 0.75 }}>
                ↓
              </div>
      ...
      <div className="absolute left-0 right-0 text-center px-[10vw]" style={{ bottom: "4.5vw" }}>
        <div style={{ height: "1px", background: "rgba(202,146,43,0.25)", marginBottom: "1.7vw" }} />
