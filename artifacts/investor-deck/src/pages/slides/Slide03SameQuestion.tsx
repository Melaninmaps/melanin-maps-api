  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden flex items-center justify-center" style={{ background: "#FAF6EF" }}>
      ...
      <div className="text-center px-[8vw]">
        <div className="font-display leading-tight" style={{ fontSize: "4.3vw", fontWeight: 700, color: "#3D2417", textWrap: "balance" }}>
          That&rsquo;s why
        </div>
        <div className="font-display leading-tight mt-[1vh]" style={{ fontSize: "6.4vw", fontWeight: 700, color: "#A6720F" }}>
