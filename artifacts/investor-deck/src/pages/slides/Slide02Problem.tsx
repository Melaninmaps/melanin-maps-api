export default function Slide02Problem() {
  return (
    <div className="w-screen h-screen overflow-hidden flex flex-col" style={{ background: "#FAF6EF" }}>
      ...
      {/* Header */}
      <div className="px-[7vw] pt-[5vh] pb-[3vh]">
        <div className="font-body mb-[1.5vh]" style={{ fontSize: "2.2vw", color: "#CA922B", letterSpacing: "0.18em", fontWeight: 300 }}>THE PROBLEM</div>
        <h2 className="font-display" style={{ fontSize: "4.5vw", fontWeight: 700, color: "#1C0E06", lineHeight: 1.15 }}>
          No trusted community layer exists for the melanated diaspora.
        </h2>
        <div className="inv-rule w-[18vw] mt-[1.5vh]" />
      </div>

      {/* 3 columns */}
      <div className="flex-1 px-[7vw] pb-[6vh]">
        <div className="flex gap-[2.5vw] h-full">
          <div className="flex-1 flex flex-col justify-start py-[3vh] px-[2.5vw]" style={{ background: "#1C0E06" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "3.2vw", fontWeight: 700, color: "#CA922B" }}>Fragmented</div>
          ...
          <div className="flex-1 flex flex-col justify-start py-[3vh] px-[2.5vw]" style={{ background: "#1C0E06" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "3.2vw", fontWeight: 700, color: "#CA922B" }}>Untrusted</div>
            <div className="inv-rule w-[3.5vw] mb-[1.5vh]" />
            <p className="font-body" style={{ fontSize: "2.5vw", fontWeight: 300, color: "#FAF6EF", lineHeight: 1.5 }}>
          ...
          <div className="flex-1 flex flex-col justify-start py-[3vh] px-[2.5vw]" style={{ background: "#1C0E06" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "3.2vw", fontWeight: 700, color: "#CA922B" }}>Static</div>
            <div className="inv-rule w-[3.5vw] mb-[1.5vh]" />
            <p className="font-body" style={{ fontSize: "2.5vw", fontWeight: 300, color: "#FAF6EF", lineHeight: 1.5 }}>
