...
export default function Slide23MeetMarcus() {
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#FAF6EF" }}>
      <div className="absolute bottom-[1.7vw] right-[5vw] font-display" style={{ fontSize: "2vw", color: "#CA922B", fontWeight: 700, opacity: 0.35 }}>23</div>
      ...
      <div className="absolute right-[5vw] top-[2.8vw]" style={{ left: "42vw" }}>
        <div className="font-body mb-[0.79vw]" style={{ fontSize: "1.3vw", color: "#CA922B", letterSpacing: "0.16em", fontWeight: 500 }}>
          A BUSINESS STORY
        </div>
        ...
        <div className="mt-[1.1vw] pl-[1vw]" style={{ borderLeft: "2px solid rgba(202,146,43,0.35)" }}>
          <div className="font-body mb-[0.34vw]" style={{ fontSize: "1vw", color: "#A6720F", letterSpacing: "0.1em", fontWeight: 600 }}>
        ...
        <div className="mt-[1.6vw]" style={{ display: "flex", flexDirection: "column", gap: "0.5vw" }}>
          {JOURNEY.map((item, i) => (
            <div key={item}>
        ...
        <div className="font-body mt-[1.4vw]" style={{ fontSize: "1.15vw", color: "#3A1F0E", fontWeight: 500 }}>
          Every recommendation helps someone else find a place they&rsquo;ll love.
        </div>

        <div className="font-display mt-[0.9vw]" style={{ fontSize: "1.4vw", color: "#A6720F", fontWeight: 700, fontStyle: "italic" }}>
          There are thousands of businesses like Marcus&rsquo;s. Great businesses deserve to be discovered.
        </div>
        <div className="font-display mt-[0.56vw]" style={{ fontSize: "1.4vw", color: "#A6720F", fontWeight: 700, fontStyle: "italic" }}>
