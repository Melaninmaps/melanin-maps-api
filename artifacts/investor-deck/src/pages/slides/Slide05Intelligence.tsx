  ...
  return (
    <div className="w-screen h-screen overflow-hidden flex flex-col" style={{ background: "#1C0E06" }}>
      ...
      <div className="relative px-[7vw] pt-[5vh] pb-[2.5vh] text-center">
        <div className="font-body mb-[1.2vh]" style={{ fontSize: "2.2vw", color: "#CA922B", letterSpacing: "0.18em", fontWeight: 300 }}>THE DATA MOAT</div>
        <h2 className="font-display" style={{ fontSize: "4.5vw", fontWeight: 700, color: "#FAF6EF" }}>
      ...
      <div className="relative flex-1 px-[7vw] pb-[6vh]">
        <div className="flex gap-[2.5vw] h-full">
          <div className="flex-1 flex flex-col items-center justify-start py-[3vh] px-[2vw] text-center" style={{ background: "rgba(202,146,43,0.1)", border: "1px solid rgba(202,146,43,0.3)" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "8vw", fontWeight: 700, color: "#CA922B", lineHeight: 1 }}>1</div>
            <div className="inv-rule w-[3.5vw] mb-[1.5vh]" />
            <div className="font-display mb-[1vh]" style={{ fontSize: "3vw", fontWeight: 700, color: "#FAF6EF" }}>Members Join</div>
            <p className="font-body" style={{ fontSize: "2.5vw", fontWeight: 300, color: "#FAF6EF", opacity: 0.85, lineHeight: 1.5 }}>
          ...
          <div className="flex-1 flex flex-col items-center justify-start py-[3vh] px-[2vw] text-center" style={{ background: "rgba(202,146,43,0.06)", border: "1px solid rgba(202,146,43,0.2)" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "8vw", fontWeight: 700, color: "#CA922B", lineHeight: 1 }}>2</div>
            <div className="inv-rule w-[3.5vw] mb-[1.5vh]" />
            <div className="font-display mb-[1vh]" style={{ fontSize: "3vw", fontWeight: 700, color: "#FAF6EF" }}>Data Accumulates</div>
            <p className="font-body" style={{ fontSize: "2.5vw", fontWeight: 300, color: "#FAF6EF", opacity: 0.85, lineHeight: 1.5 }}>
              Safety surveys, reviews, tips, and recs build a proprietary dataset no competitor can replicate.
            </p>
          </div>
          <div className="flex-1 flex flex-col items-center justify-start py-[3vh] px-[2vw] text-center" style={{ background: "rgba(202,146,43,0.1)", border: "1px solid rgba(202,146,43,0.3)" }}>
            <div className="font-display mb-[1.5vh]" style={{ fontSize: "8vw", fontWeight: 700, color: "#CA922B", lineHeight: 1 }}>3</div>
            <div className="inv-rule w-[3.5vw] mb-[1.5vh]" />
            <div className="font-display mb-[1vh]" style={{ fontSize: "3vw", fontWeight: 700, color: "#FAF6EF" }}>Value Deepens</div>
            <p className="font-body" style={{ fontSize: "2.5vw", fontWeight: 300, color: "#FAF6EF", opacity: 0.85, lineHeight: 1.5 }}>
