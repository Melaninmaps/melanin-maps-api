export default function SlideInv50Pricing() {
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#FAF6EF" }}>
      ...
      <div className="absolute" style={{ left: "6vw", right: "6vw", top: "16vw", display: "grid", gridTemplateColumns: "1fr 1.08fr 1fr", gap: "1.5vw" }}>
        <div style={{ background: "#FFFFFF", borderRadius: "1.2vw", padding: "2.2vw 1.8vw", border: "1px solid rgba(58,31,14,0.1)" }}>
          ...
          <div style={{ marginBottom: "1.2vw" }}><span className="font-display" style={{ fontSize: "3.5vw", fontWeight: 800, color: "#1C0E06", lineHeight: 1 }}>$0</span><span className="font-body" style={{ fontSize: "0.85vw", color: "#7B5408" }}> / month</span></div>
          <div className="font-body" style={{ fontSize: "0.9vw", color: "#5C3A1A", lineHeight: 1.6, marginBottom: "1.5vw" }}>Get your business on the map. Your profile, your reviews, your community.</div>
        ...
        <div style={{ background: "#3D2417", borderRadius: "1.2vw", padding: "2.2vw 1.8vw", border: "2px solid #CA922B", position: "relative", boxShadow: "0 0.4vw 2vw rgba(202,146,43,0.2)" }}>
          ...
          <div style={{ marginBottom: "1.2vw" }}><span className="font-display" style={{ fontSize: "3.5vw", fontWeight: 800, color: "#FAF6EF", lineHeight: 1 }}>$49</span><span className="font-body" style={{ fontSize: "0.85vw", color: "#A87A40" }}> / month</span></div>
          <div className="font-body" style={{ fontSize: "0.9vw", color: "#D9C4A3", lineHeight: 1.6, marginBottom: "1.5vw" }}>Everything in Free, plus the tools to grow — analytics, events, and KinfolkAI™.</div>
        ...
        <div style={{ background: "#1C0E06", borderRadius: "1.2vw", padding: "2.2vw 1.8vw", border: "1px solid rgba(202,146,43,0.3)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.6vw", marginBottom: "1vw" }}>
            ...
            <div style={{ background: "#CA922B", borderRadius: "2vw", padding: "0.15vw 0.55vw" }}><span className="font-body" style={{ fontSize: "0.55vw", color: "#1C0E06", fontWeight: 800 }}>LIMITED</span></div>
          </div>
          <div style={{ marginBottom: "0.5vw" }}><span className="font-display" style={{ fontSize: "3.5vw", fontWeight: 800, color: "#CA922B", lineHeight: 1 }}>$29</span><span className="font-body" style={{ fontSize: "0.85vw", color: "#7B5408" }}> / month</span></div>
          <div className="font-body" style={{ fontSize: "0.75vw", color: "#5A9A6F", marginBottom: "1vw" }}>Locked in for life — rate never increases</div>
          <div className="font-body" style={{ fontSize: "0.9vw", color: "#A87A40", lineHeight: 1.6, marginBottom: "1.5vw" }}>Everything in Standard plus founding badge, priority placement, marketplace access, and permanent community recognition.</div>
