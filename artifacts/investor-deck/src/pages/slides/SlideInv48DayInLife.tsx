export default function SlideInv48DayInLife() {
  const moments = [
    {
      time: "8:00 AM",
      msg: "Profile views are up 42% since yesterday. Your community is paying attention.",
      action: null,
      icon: <><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></>,
    },
    {
      time: "10:15 AM",
      msg: "People in your area are searching for brunch spots right now.",
      action: "Post a special →",
      icon: <><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></>,
    },
    {
      time: "1:00 PM",
      msg: "Three people saved your business in the last hour. Demand is building.",
      action: null,
    ...
    {
      time: "11:00 PM",
      msg: "Your trust score grew again this week. Momentum is building — and I never stopped working.",
      action: null,
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#1C0E06" }}>
      ...
      <div className="absolute left-[6vw] flex flex-col justify-center" style={{ top: "6%", bottom: "8%", width: "28vw" }}>
        <div className="font-body" style={{ fontSize: "1vw", color: "#CA922B", letterSpacing: "0.16em", fontWeight: 700, marginBottom: "0.7vw" }}>A MONDAY WITH KINFOLKAI™</div>
        ...
        <div style={{ marginTop: "2.5vw", paddingLeft: "0.1vw" }}>
          <div className="font-body" style={{ fontSize: "0.85vw", color: "#5C3A1A", lineHeight: 1.6, fontStyle: "italic" }}>
            Every notification below is based on<br />real community behavior — not generic data.
          </div>
        </div>
      </div>
      ...
      <div className="absolute" style={{ left: "39vw", right: "5vw", top: "0", bottom: "0", display: "flex", flexDirection: "column", justifyContent: "center", gap: "0" }}>
        {moments.map((m, i) => (
