export default function Slide23BiggerThan() {
  return (
    <div className="relative w-screen h-screen overflow-hidden flex items-center justify-center" style={{ background: "#3D2417" }}>
      ...
      <div className="absolute bottom-[1.7vw] right-[5vw] font-display" style={{ fontSize: "2vw", color: "#CA922B", fontWeight: 700, opacity: 0.35 }}>31</div>
      <div className="text-center px-[8vw]">
        ...
        <div className="inv-rule mx-auto w-[8vw] my-[2.3vw]" style={{ background: "#CA922B" }} />
