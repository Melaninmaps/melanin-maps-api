...
export default function Slide25FoundingInvite() {
  return (
    <div className="relative w-screen h-screen overflow-hidden flex flex-col items-center justify-center" style={{ background: "#3D2417" }}>
      ...
      <div className="absolute bottom-[3vh] right-[5vw] font-display" style={{ fontSize: "2vw", color: "#CA922B", fontWeight: 700, opacity: 0.35 }}>33</div>

      <div className="text-center px-[8vw]">
        <div className="font-body mb-[5vh]" style={{ fontSize: "1.4vw", color: "#CA922B", letterSpacing: "0.18em", fontWeight: 500 }}>
          JOIN US
        </div>

        <div className="flex flex-col" style={{ gap: "2.4vh" }}>
          {LINES.map((line, i) => (
            <div
              key={line.text}
        ...
        <div className="inv-rule mx-auto w-[8vw] mt-[5vh] mb-[3vh]" />
