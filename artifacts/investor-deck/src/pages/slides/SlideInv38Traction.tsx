  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#FAF6EF" }}>
      ...
      <div className="absolute left-[6vw] top-[3.5vw]">
        ...
        <div className="font-display" style={{ fontSize: "3.5vw", fontWeight: 700, color: "#1C0E06", lineHeight: 1.1, marginTop: "0.5vw" }}>
          The Platform Is Live.
        </div>
        <div className="font-display" style={{ fontSize: "3.5vw", fontWeight: 700, color: "#CA922B", lineHeight: 1.1 }}>
      ...
      {/* Vertical divider 1 */}
      <div className="absolute" style={{ left: "35vw", top: "20vw", bottom: "5.5vw", width: "1px", background: "rgba(58,31,14,0.1)" }} />
      ...
      {/* Vertical divider 2 */}
      <div className="absolute" style={{ left: "66vw", top: "20vw", bottom: "5.5vw", width: "1px", background: "rgba(58,31,14,0.1)" }} />
