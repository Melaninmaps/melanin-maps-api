  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden flex items-center justify-center" style={{ background: "#FAF6EF" }}>
      ...
      <div className="text-center px-[8vw]">
        ...
        <div className="font-display leading-tight mt-[1.1vw]" style={{ fontSize: "6.2vw", fontWeight: 700, color: "#1C0E06", textWrap: "balance" }}>
          A community ecosystem.
        </div>
        <div className="font-display mt-[1.7vw]" style={{ fontSize: "2vw", fontWeight: 700, fontStyle: "italic", color: "#A6720F", textWrap: "balance" }}>
