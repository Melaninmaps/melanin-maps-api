export default function SlideInv47KinfolkAI() {
  const capabilities = [
    { title: "Creates posts", body: "Drafts ready-to-share marketing content based on your business, neighborhood, and community events.", icon: <><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></> },
    { title: "Responds to reviews", body: "Writes thoughtful, on-brand replies to community feedback — so every customer feels heard.", icon: <><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></> },
    { title: "Finds customer trends", body: "Spots patterns in what your customers are saving, searching, and saying before you'd notice them yourself.", icon: <><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></> },
    { title: "Suggests promotions", body: "Recommends the right offers at the right time — timed to community activity, not guesswork.", icon: <><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></> },
    { title: "Identifies growth opportunities", body: "Surfaces untapped moments — new neighborhoods, event timing, rising search categories near you.", icon: <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></> },
    { title: "Alerts you when something needs attention", body: "Notifies you instantly when a review needs a response, a trend shifts, or a promotion window opens.", icon: <><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></> },
  ];
