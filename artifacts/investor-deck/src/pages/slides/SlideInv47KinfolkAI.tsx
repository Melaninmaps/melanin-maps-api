export default function SlideInv47KinfolkAI() {
  const capabilities = [
    {
      label: "I learn.",
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#1C0E06" }}>
      <div className="absolute inset-0" style={{ background: "radial-gradient(circle at 22% 50%, rgba(202,146,43,0.14), transparent 50%)" }} />

      {/* Left column */}
      <div className="absolute left-[6vw] flex flex-col justify-center" style={{ top: "6%", bottom: "8%", width: "29vw" }}>
        ...
        <div className="font-display" style={{ fontSize: "3.1vw", fontWeight: 800, color: "#FAF6EF", lineHeight: 1.1, marginBottom: "1.2vw" }}>
          Your business partner.<br />
          <span style={{ color: "#CA922B" }}>Working even when<br />you're closed.</span>
        </div>
        <div className="font-body" style={{ fontSize: "1.05vw", color: "#A87A40", lineHeight: 1.7, marginBottom: "1.8vw" }}>
        ...
        {/* "Always listening" icon — concentric rings */}
        <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
          <div style={{ position: "relative", width: "5.5vw", height: "5.5vw", flexShrink: 0 }}>
            <svg viewBox="0 0 90 90" width="100%" height="100%">
              <circle cx="45" cy="45" r="42" fill="none" stroke="rgba(202,146,43,0.08)" strokeWidth="1.2" />
              <circle cx="45" cy="45" r="34" fill="none" stroke="rgba(202,146,43,0.14)" strokeWidth="1.2" />
              <circle cx="45" cy="45" r="25" fill="none" stroke="rgba(202,146,43,0.22)" strokeWidth="1.2" />
              <circle cx="45" cy="45" r="16" fill="rgba(202,146,43,0.1)" stroke="rgba(202,146,43,0.45)" strokeWidth="1.5" />
              <polygon points="45,34 48.7,41.3 57,42.5 51,48.3 52.4,56.5 45,52.7 37.6,56.5 39,48.3 33,42.5 41.3,41.3"
                fill="none" stroke="#CA922B" strokeWidth="1.5" strokeLinejoin="round" />
            </svg>
          </div>
          <div className="font-body" style={{ fontSize: "0.85vw", color: "#5C3A1A", lineHeight: 1.5, fontStyle: "italic" }}>
            Powered by real community behavior —<br />not generic internet data.
          </div>
        </div>
      </div>

      {/* Divider */}
      <div className="absolute" style={{ left: "38vw", top: "6%", bottom: "8%", width: "1px", background: "rgba(202,146,43,0.2)" }} />

      {/* Right column — capabilities reordered to tell a story */}
      <div className="absolute" style={{ left: "40vw", right: "5vw", top: "6%", bottom: "8%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.6vw 2.4vw", alignContent: "center" }}>
        {capabilities.map((cap, i) => (
          <div key={i} style={{ display: "flex", flexDirection: "column", gap: "0.35vw" }}>
            ...
            <div className="font-body" style={{ fontSize: "0.8vw", color: "#7B5408", lineHeight: 1.55, paddingLeft: "2.4vw" }}>{cap.body}</div>
          </div>
        ))}
      </div>
