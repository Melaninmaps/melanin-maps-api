  ...
  return (
    <div className="min-h-screen bg-[#1A0A00] flex flex-col" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <div className="overflow-y-auto flex-1 pb-24">
        ...
        {/* Own a Business CTA */}
        <div className="mx-4 mt-3 bg-[#CA922B] rounded-2xl p-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center shrink-0">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
          </div>
          <div className="flex-1">
            <p className="text-white font-bold text-sm">Own a Business?</p>
            <p className="text-white/70 text-xs mt-0.5">Get discovered by thousands of locals and travelers — listing is free.</p>
          </div>
          <div className="bg-white/20 rounded-full px-3 py-1.5 flex items-center gap-1">
            <span className="text-white text-xs font-bold">List Free</span>
        ...
        <div className="mx-4 mt-3 bg-[#3B1F0E] rounded-2xl p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div>
              ...
              <p className="text-white/50 text-xs">You're building something real</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
            {[
              { num: "14", label: "🏪 Businesses\nSupported" },
              { num: "3", label: "🌍 Cities\nExplored" },
              { num: "8", label: "☕ Coffee Shops\nDiscovered" },
              { num: "2", label: "🎉 Events\nAttended" },
            ].map((cell) => (
          ...
          <p className="text-white/40 text-[11px] mt-3 text-center">Every check-in, review, and visit makes a difference. Keep going. 🔥</p>
        </div>

        {/* Points redemption banner */}
        <div className="mx-4 mt-3 flex items-center gap-3 bg-[#CA922B]/10 border border-[#CA922B]/25 rounded-2xl p-4">
          <div className="w-9 h-9 rounded-xl bg-[#CA922B]/20 flex items-center justify-center shrink-0">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#CA922B" strokeWidth="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
          </div>
          <div className="flex-1">
            <p className="text-[#CA922B] font-bold text-sm">Redeem Your Points</p>
            <p className="text-[#CA922B]/60 text-xs mt-0.5">2,340 pts available — free months, badges & more</p>
          </div>
        ...
        <div className="mx-4 mt-3 bg-[#231200] rounded-2xl border border-white/8 overflow-hidden">
          {[
            ...
            { icon: "compass", label: "Explore", sub: "Discover new places" },
          ].map((item, i) => (
            <div key={item.label} className={`flex items-center gap-3 px-4 py-3.5 ${i < 3 ? "border-b border-white/8" : ""}`}>
              <div className="w-8 h-8 rounded-xl bg-[#CA922B]/15 flex items-center justify-center">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#CA922B" strokeWidth="2">
                  ...
                  {item.icon === "compass" && <><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></>}
                </svg>
              </div>
              <div className="flex-1">
