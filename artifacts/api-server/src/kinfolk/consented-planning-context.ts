...
const FINANCIAL_MEMORY = /\b(?:hours? (?:were|was|have been|got) reduced|reduced hours?|cut hours?|pay cut|income (?:dropped|reduced)|lost (?:my )?job|laid off|layoff|unemploy(?:ed|ment)|financial hardship|money is tight|tight budget|cannot afford|can't afford|behind on bills|debt)\b/i;
...
const FAMILY_REQUEST = /\b(?:my (?:child|children|kid|kids|son|daughter)|family|caregiv(?:er|ing)|my (?:mom|mother|dad|father|parent|grandmother|grandma|grandfather|grandpa))\b/i;
