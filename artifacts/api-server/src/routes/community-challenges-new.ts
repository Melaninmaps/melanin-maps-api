...
const DEFAULT_CHALLENGES = [
  ...
  { title: "Try a New Restaurant", description: "Visit and review a minority-owned restaurant you haven't tried yet.", icon: "🍽️", challengeType: "restaurant_review", targetCount: 1, pointsReward: 40 },
  { title: "Visit a Black Museum or Gallery", description: "Check in to a minority-owned or Black-focused cultural space.", icon: "🎨", challengeType: "cultural_checkin", targetCount: 1, pointsReward: 50 },
