...
const CONCEPT_TO_CATEGORY: Record<string, string[]> = {
  ...
  pho:           ["Food"],
  // ── Automotive ───────────────────────────────────────────────────────────
  transmission:  ["Automotive", "Health"],  // multi-intent: car transmission OR STI/health
  mechanic:      ["Automotive"],
  ...
  // Health terms that were missing — causing "stroke" / "shot" / "vaccine" → 0 results
  stroke:           ["Health"],
  "heart attack":   ["Health"],
  cardiac:          ["Health"],
  cardiology:       ["Health"],
  ...
  bloodwork:        ["Health"],
  "blood work":     ["Health"],
  // "shot" and "shots" are intentionally multi-intent — nightlife AND health/immunization
  shot:             ["Food", "Health"],
  shots:            ["Food", "Health"],
