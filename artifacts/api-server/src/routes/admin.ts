...
const SEED_TOPICS: Array<{ topicName: string; category: string; description: string; keywords: string[]; notificationPriority: string; trustedSources: object }> = [
  ...
  { topicName: "Neighborhood Safety", category: "safety", description: "Community experience reports, crime trends, and neighborhood watch updates.", keywords: ["neighborhood safety", "crime prevention", "community intelligence", "local conditions"], notificationPriority: "breaking", trustedSources: [{ name: "FBI Crime Data", domain: "fbi.gov" }, { name: "NAACP", domain: "naacp.org" }] },
  ...
  { topicName: "Community Alerts", category: "platform", description: "Real-time community alerts and Waze-style incident reports from the MWM community — police presence, ICE activity, and safety incidents.", keywords: ["community alert", "safety alert", "ice activity", "police presence", "neighborhood alert"], notificationPriority: "breaking", trustedSources: [{ name: "Mapping With Melanin Community", domain: "mappingwithmelanin.com" }] },
  { topicName: "Black Travel Guides", category: "platform", description: "Destination guides, Community Intelligence by city, and travel content from the MWM travel community.", keywords: ["black travel guide", "mwm travel", "destination guide", "community intelligence", "travel tips"], notificationPriority: "digest", trustedSources: [{ name: "Mapping With Melanin", domain: "mappingwithmelanin.com" }] },
