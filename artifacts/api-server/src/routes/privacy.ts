...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Community Intelligence", body: "Aggregated and anonymized community survey data contributes to Community Intelligence — shared context about arrival, access, and practical conditions. Individual submissions are never publicly displayed. Community Intelligence is not a neighborhood safety score based on demographic composition." },
...
router.get("/terms", (_req: Request, res: Response) => {
  ...
  const body = `
    ...
    <section><h2>2. Description of Service</h2><p>Mapping With Melanin™ is a community discovery, travel, and business platform. We provide tools for users to find minority-owned businesses, access Community Intelligence (community-sourced context for informed choices), and plan culturally informed travel.</p></section>
...
router.get("/delete-account", (_req: Request, res: Response) => {
  ...
  const body = `
    ...
    <section>
      ...
      <p style="margin-top:8px;">Aggregated, anonymized Community Intelligence data (such as community-sourced context about arrival and access conditions) cannot be attributed to you and is not deleted.</p>
    </section>
    <section>
      <h2>Questions</h2>
