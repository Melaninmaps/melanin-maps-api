...
ON CONFLICT (city_slug) DO NOTHING`,
  ...
  {
    // Well-known tourist sites for Jamaica, Cancun/Tulum/Riviera Maya, and Santorini.
    // Extends the same Library pattern as seed_sea_tourist_sites_v1 to the Caribbean
    // and Mediterranean destinations already on the platform. Not promoted businesses —
    // waterfalls, ruins, beaches, and landmarks for travelers of the African diaspora.
    name: "seed_caribbean_mediterranean_tourist_sites_v1",
    sql: `
      INSERT INTO knowledge_topics (id, topic_name, category, description, node_type)
      SELECT gen_random_uuid(), v.n, 'travel', v.d, 'geography'
      FROM (VALUES
        ...
        ('Dunn''s River Falls, Ocho Rios, Jamaica',
         'One of the most famous natural attractions in the Caribbean — a terraced series of limestone waterfalls on Jamaica''s north coast that visitors climb in a human chain from the base to the top, guided by certified river guides. The falls cascade 180 meters over natural rock terraces directly to a white sand beach where the Caribbean Sea begins. Dunn''s River is a living landscape that rebuilds itself continuously as calcium carbonate deposits layer the rock. The climb takes about an hour and is rated easy to moderate — water shoes are essential and available for rent at the entrance. The beach at the base is swimmable and has vendors selling jerk, fresh coconuts, and seafood. Located 3 kilometers west of Ocho Rios town. Most visitors combine this with a day trip from Montego Bay (90 minutes west) or Negril (3.5 hours). Admission: USD $30. Arrive early — the falls become extremely crowded by mid-morning during cruise ship days. Best experienced on non-cruise days.'),

        ('Blue Mountains, Jamaica',
         'The highest mountain range in Jamaica — a UNESCO World Heritage Site and biodiversity hotspot stretching across the eastern parishes of St. Andrew, St. Thomas, and Portland, with Blue Mountain Peak reaching 2,256 meters. The range is the origin of Blue Mountain Coffee, widely considered one of the finest and most expensive coffees in the world, grown at elevations above 900 meters in the cool, misty highland climate. The most popular experience is the pre-dawn hike to Blue Mountain Peak (14 kilometers round trip, 4–5 hours each way), timed to arrive at the summit for sunrise with views stretching to Cuba on clear mornings. Local coffee estate tours in Mavis Bank and Silver Hill offer a more accessible experience — tasting freshly roasted beans and walking the terraced slopes. The mountains are also home to the streamertail hummingbird (Jamaica''s national bird) and endemic tree species. Base camps in Mavis Bank provide overnight accommodation for peak hikers. A 2-hour drive from Kingston via the B1 mountain road.'),

        ('Bob Marley Museum, Kingston, Jamaica',
         'The most visited cultural site in Jamaica — the former home and recording studio of Robert Nesta Marley, located on Hope Road in uptown Kingston, now preserved as a museum and cultural institution managed by the Marley family. The site includes the house where Bob Marley lived from 1975 until his death in 1981, the Tuff Gong Recording Studio where some of the most influential reggae albums in history were recorded, the bullet-riddled wall from the 1976 assassination attempt, and gardens dedicated to Rastafari symbolism. Guided tours run 90 minutes and include personal memorabilia, gold and platinum records, concert footage, and the room where Marley healed after the shooting. The gift shop and café are operated by the family and carry official merchandise. Admission: USD $20. Open Monday–Saturday 9:30am–4pm. Located in the New Kingston district — accessible by taxi from downtown Kingston. An essential stop for any traveler of the African diaspora.'),

        ('Rick''s Café, Negril, Jamaica',
         'The most iconic sunset experience in Jamaica — a cliffside bar and restaurant on the West End of Negril where limestone cliffs 10–25 feet above the Caribbean Sea serve as natural diving platforms, and the sunset over open water stops conversation every evening. Rick''s has operated since 1974 and has become a pillar of Jamaican travel culture, drawing a mixed crowd of locals, expats, and international visitors who come specifically for the cliff diving, the rum punch, and the ritual of watching professional cliff divers leap from progressively higher perches before sunset. The bar serves Jamaican food (jerk chicken, fish, festival) alongside cocktails. Entry fee waived with food and drink purchase. Located on the cliffside road (West End Road) about 7 kilometers from Negril town square. Best arriving 2 hours before sunset to claim a cliffside table. The surrounding West End cliff road has several other smaller cliff-jump spots with sea access at no charge.'),

        ('YS Falls, St. Elizabeth, Jamaica',
         'Seven cascading waterfalls on a 2,000-acre estate in the fertile Black River Valley of St. Elizabeth — considered by many Jamaicans to be the most beautiful waterfall experience on the island, largely because it remains privately owned and limits daily visitors. The falls are set on a working cattle and horse farm; the access road passes through open pastureland and crosses a covered bridge before arriving at the falls. A zip-line runs above the river. Natural rock pools at each tier are swimmable. Rope swings hang from the trees at the largest pool. Onsite restaurant serves Jamaican food. Admission includes all activities except the zip-line. Located about 15 kilometers north of Black River town and 2 hours from Montego Bay — best reached by rental car or organized excursion. Open Tuesday–Sunday 9:30am–3:30pm (closed Monday). The estate''s remote location means it is significantly less crowded than Dunn''s River Falls; advance booking recommended on peak-season weekends.'),

        ('Rose Hall Great House, Montego Bay, Jamaica',
         'A restored Georgian plantation great house on a hilltop above Montego Bay — one of the most visited historic sites in the Caribbean, famous for the legend of Annie Palmer, the "White Witch of Rose Hall," said to have murdered three husbands and controlled enslaved workers through obeah (Afro-Caribbean spiritual practice). The house was built in the 1770s and fell into ruin before restoration in the 1960s by American businessman John Rollins, who furnished it with period antiques. The site embodies the brutal history of the plantation system in Jamaica; the legend of Annie Palmer has roots in the real terror of enslaved life on sugar estates. Daytime tours cover the furnished interiors; evening ghost tours (especially popular) retell the Palmer legend with theatrical staging. Located on the A1 coastal highway 15 kilometers east of Montego Bay airport. Admission: daytime USD $30 / evening tours USD $40. The adjacent Cinnamon Hill estate was owned by Johnny Cash, who is buried on the property.'),

        ('Boston Beach, Port Antonio, Jamaica',
         'A small black-sand beach on Jamaica''s rugged northeastern coast, widely celebrated as the birthplace of Jamaican jerk seasoning — a cooking tradition rooted in the Maroon communities of the Blue Mountains, who developed pit-smoked, allspice-and-scotch-bonnet-seasoned pork and chicken as a means of preservation and cultural identity. The vendors at Boston Beach have operated pimento wood jerk pits on this same stretch of road for generations; the jerk pork here is generally regarded as the most authentic in Jamaica. The beach itself is backed by the Blue Mountains and faces the Caribbean — swimming conditions depend on wave action, which can be rough. Port Antonio, 10 kilometers west, is one of Jamaica''s most culturally rich and least touristy towns: the former home of Errol Flynn, the origin of the bamboo river raft float on the Rio Grande, and the gateway to Reach Falls and the Blue Lagoon. About 2.5 hours from Kingston by road.'),

        ('Mayfield Falls, Westmoreland, Jamaica',
         'A spring-fed waterfall in the rural hills of Westmoreland parish — one of Jamaica''s best-kept natural secrets, far less visited than Dunn''s River Falls despite offering a comparable and in many ways more intimate experience. The falls flow through a forest of ferns, bamboo, and tropical trees; the water is mineral-rich and noticeably cooler than the surrounding heat. Visitors wade and swim upstream through a sequence of natural pools and small cascades guided by local guides who know every pool, rock, and natural shower in the system. The walk takes about 90 minutes each way. The remote setting means crowds are rare even on peak weekends. Located near the village of Cascade, about 45 minutes from Negril by car or organized tour. Admission: USD $20 including guide. The surrounding hills are farmland — the drive passes through working communities rarely on any tourist itinerary. Bring water shoes and a change of clothes.'),

        -- ── CANCUN / TULUM / RIVIERA MAYA ──────────────────────────────────────────
        ('Chichen Itza, Yucatán, Mexico',
         'One of the Seven Wonders of the Modern World and the most visited archaeological site in Mexico — the ruins of a major Mayan city that flourished between the 7th and 13th centuries, covering four square kilometers of the Yucatán jungle. The central pyramid El Castillo (Temple of Kukulcán) is the defining image: a 30-meter stepped pyramid aligned so precisely to the solar calendar that on the spring and autumn equinoxes, the shadow of a feathered serpent descends the north staircase at sunset. The site also contains the Great Ball Court (the largest in Mesoamerica), the Sacred Cenote (a natural well used for ceremonial offerings), and the Temple of Warriors. Located about 200 kilometers from Cancun (2.5 hours by bus), Chichen Itza is most commonly visited as a full-day trip from the Hotel Zone. Arrive by 8am before tour buses arrive — the site becomes extremely crowded by 11am. Admission: 481 Mexican pesos (foreigners). The nearby town of Valladolid (45 minutes east) makes an excellent base for slower visits and is worth exploring on its own.'),

        ('Tulum Ruins, Mexico',
         'The only major Mayan city built on the Caribbean coastline — a walled ceremonial complex perched on a 12-meter cliff above a turquoise cove on the Yucatán Peninsula. Tulum was a living port city and trading hub from roughly 1200–1600 CE, continuing to be inhabited after Spanish contact. The main structure, El Castillo, served as a lighthouse to guide Mayan canoes through the reef. The site is compact and walkable in 60–90 minutes; a staircase leads from the ruins down to a small beach at the base of the cliff that is one of the most photographed spots in Mexico. The Tulum ruins are located 1.5 kilometers north of Tulum town — accessible by bicycle from the town (recommended), by taxi, or on foot. Open daily 8am–5pm. Admission: 100 Mexican pesos. Arrive before 9am to experience the clifftop and beach before the crowds arrive. The Tulum archaeological site is distinct from the Tulum Hotel Zone (Zona Hotelera), which is 3 kilometers south along the beach.'),

        ('Gran Cenote, Tulum, Mexico',
         'The most accessible and visually stunning cenote near Tulum — a large open-air sinkhole with a crystal-clear freshwater pool, stalactite-draped cave chambers, and visibility extending 10–15 meters into the blue underwater world. Gran Cenote is an entry point to one of the world''s longest underground river systems. Snorkeling is available in the open-air section; certified cave diving is possible for licensed divers in the cave chambers. Sea turtles frequently swim in the open section. The surrounding area has hammocks, a picnic area, and changing rooms. Located on the road between Tulum town and Coba — accessible by bicycle (5 kilometers from Tulum town), by taxi, or on a cenote tour. Admission: 180 pesos. Open daily 8am–5pm. Visit early morning for calmest water and fewest crowds. Gran Cenote is often paired with Cenote Calavera (a vertical drop-in cenote 2 kilometers north) and Dos Ojos (further north, more cave-focused) for a full cenote day.'),

        ('Dos Ojos Cenote, Riviera Maya, Mexico',
         'One of the most spectacular cenote systems in the Yucatán — a pair of connected sinkholes (Spanish: "two eyes") that serve as the entry points to an explored underwater cave network spanning over 82 kilometers. The two main pools offer dramatically different experiences: the first is a wide, open-air cenote with shallow clear water ideal for snorkeling; the second is a deeper, partially cavern-covered pool with bat cave formations and a halocline (a visible boundary layer where freshwater meets saltwater) that creates a surreal shimmering visual effect. Guided snorkeling tours navigate through passages connecting the two eyes, passing stalactites and ancient Mayan artifacts left as offerings in the caves. Scuba cave diving tours go deeper into the system. Located on the road between Tulum and Playa del Carmen, about 24 kilometers north of Tulum town. Accessible by taxi or organized tour. Admission: 350–500 pesos depending on package. Open 8am–5pm.'),

        ('Xcaret Park, Riviera Maya, Mexico',
         'A large-scale eco-archaeological park on the Riviera Maya coast — simultaneously a theme park, Mayan heritage site, natural reserve, and cultural showcase covering 40 hectares south of Playa del Carmen. The park''s centerpiece experiences include swimming through underground river tunnels lit by natural sinkholes; snorkeling in the coral reef lagoon; a butterfly pavilion housing 50+ endemic species; and the nightly Xcaret México Espectacular show — a two-hour live performance tracing 3,500 years of Mexican cultural history from Mayan civilization through independence, featuring over 300 performers. The park also houses a Mayan village recreation, sea turtle conservation program, and a manatee sanctuary. Admission: USD $130 (all-inclusive) or $80 (park-only). Open daily 8:30am–9:30pm (show ends midnight). Bus service from Cancun and Playa del Carmen hotels is included with most packages. A full day is needed to experience the major attractions. Advance booking strongly recommended. The park''s sister property, Xplor (adrenaline-focused), is located 5 kilometers north.'),

        ('Isla Mujeres, Quintana Roo, Mexico',
         'A 7-kilometer island 11 kilometers off the Cancun coastline — one of the most accessible and beloved day trips from Cancun, offering a completely different pace from the Hotel Zone''s resort strip. Isla Mujeres has a permanent community of about 13,000 residents and a centuries-old fishing culture; the main street (Hidalgo) is a pedestrian lane of colorful storefronts, seafood restaurants, and art galleries. Playa Norte, at the island''s north tip, is consistently rated among the best beaches in Mexico: calm, shallow turquoise water and powdery white sand that stays cool even at noon. The island also hosts MUSA, an underwater museum of submerged sculptures that form an artificial reef open to snorkelers and divers. Golf cart rentals (the primary local transport) allow full island exploration in a few hours. Ferry from Puerto Juárez dock in Cancun: 20–30 minutes, 200 pesos round trip. Day trips are possible; overnight stays at the island''s small hotels and guesthouses are significantly cheaper than Cancun.'),

        ('Isla Holbox, Yucatán, Mexico',
         'A remote sand-and-shell barrier island at the northern tip of the Yucatán Peninsula — accessible only by ferry from the fishing village of Chiquilá, with no paved roads, no cars (golf carts and bicycles only), and bioluminescent water that glows blue-green after dark. Holbox sits at the confluence of the Caribbean Sea and the Gulf of Mexico; the resulting mix of warm, shallow water with sandbars and flamingo wading grounds gives the island an otherworldly quality unlike anywhere else in Mexico. The island is part of the Yosakila biosphere reserve. From June through September, whale sharks congregate in the nearby waters — Holbox is one of the best places in the world to swim with whale sharks on organized boat tours. The main town has no chain hotels; accommodation is at small palapa-style guesthouses and boutique hotels. Beach bars serve fresh ceviche and cold beer directly on the sand. From Cancun: 2–2.5 hours by bus to Chiquilá + 25-minute ferry. Best visited May–September (whale shark season) or November–February.'),

        ('Cobá Ruins, Quintana Roo, Mexico',
         'A vast Mayan city in the jungle interior of the Yucatán — once home to an estimated 50,000 people, connected to dozens of other Mayan settlements by ancient stone causeways (sacbeob) that stretch straight through the forest for up to 100 kilometers. Cobá''s central pyramid, Nohoch Mul, stands 42 meters tall and — unlike Chichen Itza — remained climbable until 2020 and may reopen with timed access; check current status before visiting. The site spreads across two lake-connected jungle clearings, requiring at least 2–3 hours to walk; bicycle and tricycle taxi rentals are available at the entrance for faster navigation between temple groups. The jungle canopy means significantly more shade than Tulum or Chichen Itza — a meaningful advantage in midday heat. Located 42 kilometers inland from Tulum (40 minutes by car) and 155 kilometers from Cancun. Admission: 95 pesos. Open daily 8am–5pm. Best combined with a cenote stop on the Tulum–Cobá road.'),

        -- ── SANTORINI, GREECE ───────────────────────────────────────────────────────
        ('Oia Village, Santorini, Greece',
         'The most photographed village in Greece and one of the most iconic sunset destinations on earth — a clifftop settlement of cave houses, blue-domed churches, and cascading bougainvillea built into the volcanic caldera rim at the northern tip of Santorini. Oia''s west-facing position over the caldera makes it the definitive place to watch the sun set into the sea, a ritual that draws hundreds of visitors to the castle ruins (Kasteli) and the narrow lanes above the caldera wall every evening. The village is also one of the most romantic and architecturally beautiful in the Mediterranean: small wine shops, art galleries, and fine dining restaurants occupy the whitewashed cave interiors. The most dramatic caldera views are from the stepped path between Oia and Ammoudi Bay below. Reach Oia from Fira (the capital) by the 10-kilometer caldera walking path (2–3 hours), by bus (30 minutes), or by ATV rental. Book sunset dinners with caldera views weeks in advance in July–August. Best months: May–June and September–October for fewer crowds.'),

        ('Akrotiri Archaeological Site, Santorini, Greece',
         'A remarkably preserved Minoan Bronze Age city buried under volcanic ash from the catastrophic Santorini eruption of around 1627 BCE — often called the "Pompeii of the Aegean." The excavation, begun in 1967 and still ongoing, has uncovered multi-story buildings with intact stairways, sophisticated drainage systems, and vivid frescoes that reveal a wealthy, cosmopolitan civilization with extensive trade links across the eastern Mediterranean. Unlike Pompeii, no human remains have been found — the population apparently evacuated before the eruption. The site is covered by a modern protective roof that allows year-round visiting; excavated interiors are visible from elevated walkways. The frescoes (originals in the National Archaeological Museum in Athens and the Museum of Prehistoric Thera in Fira) include a famous flotilla scene showing a detailed Minoan town and fleet. Located at the southern tip of Santorini, 12 kilometers from Fira. Open Tuesday–Sunday 8am–3pm. Admission: €12. Essential context for understanding the Minoan civilization that may have inspired the Atlantis legend.'),

        ('Perissa & Perivolos Black Sand Beach, Santorini, Greece',
         'Santorini''s signature black sand beaches on the island''s southeastern coast — volcanic beaches unlike any in the Mediterranean, where the sand is formed from pulverized lava and obsidian left by the ancient caldera eruption. Perissa (the main village beach) and Perivolos (the continuation south) together form a 7-kilometer stretch of black sand backed by a wall of volcanic cliffs and facing the deep blue Aegean. The beach has a lively strip of beach bars, water sports, and seafood tavernas. The black sand absorbs heat intensely — beach shoes are essential in summer. The volcanic cliff at the south end of Perissa is Mesa Vouno; ancient Thira, an ancient Greek and Roman city, occupies its summit (accessible by a 45-minute walk or donkey ride, free entry). Crystal-clear Aegean water with good visibility for snorkeling in the headland areas. Located on the opposite side of the island from the caldera; the contrast between the black sand coast and the white-and-blue caldera side is one of Santorini''s most striking dualities. Accessible by bus from Fira (25 minutes) or ATV rental.'),

        ('Santorini Caldera Boat Cruise',
         'The essential on-water experience of Santorini — a boat journey into the active volcanic caldera that defines the island''s geography, visiting the submerged volcanic vent islands of Nea Kameni and Palea Kameni, natural hot springs, and the cliffside village of Thirasia, the quieter island across the caldera from Santorini''s main settlements. The caldera was formed by the catastrophic Bronze Age eruption that may have destroyed the Minoan civilization; the volcanic cone at its center has erupted as recently as 1950 and remains geothermally active. Standard day cruises (8 hours, €50–90) depart from Fira''s old port (Ammoudi-level, reached by cable car or 300 steps) or Athinios port and typically include swimming in the hot springs (naturally warm sulfurous water that stains swimwear yellow-orange), hiking the volcanic crater, lunch on Thirasia, and sunset from the water. Catamaran sunset cruises (4 hours, €80–120) focus on the caldera rim views at golden hour with onboard dinner. The perspective from the water — looking up at Fira and Oia clinging to the 300-meter caldera walls — is unavailable from land.'),

        ('Fira — Capital of Santorini, Greece',
         'The main town of Santorini, built along the caldera rim with some of the most dramatic urban views in the world — white buildings stacked at the edge of a 300-meter volcanic cliff dropping to the caldera and, in the distance, the Aegean. Fira is the island''s commercial and transport center: the bus terminal, main shopping street (Erythrou Stavrou), and taxi stand are all here. The caldera edge has a pedestrian promenade lined with restaurants and bars with unobstructed caldera views. The Museum of Prehistoric Thera houses the finest Akrotiri frescoes removed from the excavation site, including the famous Boxing Children and Spring frescoes — a world-class collection in a small museum. The old port below (Ammoudi-level, now mainly for cruise ship tenders and boat tours) is reached by cable car (€6 one way), 580 steps, or donkey (controversial — animal welfare concerns are widely documented). From Fira, the 10-kilometer caldera walking path leads north to Imerovigli and Oia — the finest walking experience on the island. Best explored early morning before the cruise ship day-trip crowd arrives.'),

        ('Amoudi Bay, Santorini, Greece',
         'A tiny, dramatically beautiful fishing port 300 meters directly below Oia village — reached by a steep path of 200 steps or by driving around the northern tip of the island. Amoudi Bay is one of the most peaceful spots on Santorini: a handful of seafood tavernas built at water level beside moored fishing boats, serving the freshest grilled octopus, sea urchin, and whole fish directly from the boats. The volcanic rocks at the bay''s entrance are a popular cliff-jumping spot — jumps of 5–12 meters into clear 10-meter-deep water. The bay is also the departure point for boat tours of the caldera. At sunset, the walk down the Oia steps to Amoudi (and back up after dinner) is one of the most beautiful experiences on the island — the path passes through the sea-level red and black volcanic rock formations unique to this part of the caldera. The tavernas here are consistently rated among the best seafood restaurants in Santorini at prices considerably lower than the caldera-view establishments above. Reservations recommended for dinner in peak season.'),

        ('Imerovigli, Santorini, Greece',
         'The quietest and highest of Santorini''s three caldera-rim villages — perched at 300 meters on the Skaros Rock promontory between Fira and Oia, offering what many consider the finest caldera views on the island without Oia''s crowds. Imerovigli (meaning "day watchman" in Greek) was historically the island''s lookout point for pirate attacks; the ruins of Skaros Castle sit on the adjacent volcanic rock accessible by a narrow trail. The village itself is small — two main streets, a handful of boutique cave hotels, a few restaurants, and the 17th-century church of Anastasi as its center. Sunrise here is especially dramatic: the caldera fills with early light and the silhouette of Thirassia across the water emerges from the blue. Located midway on the caldera walking path between Fira (20 minutes south) and Oia (90 minutes north) — a natural rest stop on the full caldera hike. The cave hotels in Imerovigli (infinity pool suites built into the volcanic cliff) are among the most sought-after accommodations in the Mediterranean; book 6–12 months in advance for summer.')
