...
VALUES
  ...
  ('memphis','Memphis','Beale Street, Stax Records, the Lorraine Motel — Memphis is where the blues became soul, and where the movement paid its heaviest price.','Memphis''s Beale Street was the home of W.C. Handy, the Father of the Blues, and a launching pad for generations of Black musical genius. Stax Records produced some of the defining sounds of soul with Otis Redding and Isaac Hayes. The Lorraine Motel, where Dr. King was assassinated in 1968, is now the National Civil Rights Museum — making Memphis both a site of profound grief and enduring cultural pride.'),
  ('boston','Boston','Boston has a complex racial history, but the Black community here — centered in Roxbury and Dorchester — has built enduring institutions across three centuries.','Boston was home to abolitionists like Frederick Douglass and William Lloyd Garrison, yet the city also has a history of intense racism including the violent resistance to school desegregation busing in the 1970s. The Museum of African American History and the Black Heritage Trail on Beacon Hill tell the story of Boston''s free Black community before the Civil War. Today Roxbury and Dorchester are home to a vibrant Black community alongside large Caribbean, Cape Verdean, and Latino populations.'),
  ...
  ('nashville','Nashville','Fisk University, Tennessee State, and the Jefferson Street corridor — Nashville helped make this the Athens of the South, and the city''s Black community has the receipts.','Nashville''s Fisk University was founded in 1866 and produced W.E.B. Du Bois; its Jubilee Singers introduced African American spirituals to the world. Jefferson Street was a legendary corridor where Jimi Hendrix, Little Richard, and Etta James all performed for Black audiences during segregation. Today Nashville is experiencing a cultural renaissance, with its Black community reclaiming space alongside a rapidly growing Latino and immigrant population.'),
  ('kansas-city','Kansas City','Charlie Parker and 18th & Vine — Kansas City gave the world a jazz tradition that still echoes, rooted in a Black community that built something extraordinary.','Kansas City''s 18th & Vine district was one of the premier jazz and blues corridors in the country during the 1920s-1940s. Count Basie, Charlie Parker, and Big Joe Turner all came from this scene. The American Jazz Museum and Negro Leagues Baseball Museum preserve a legacy that belongs to the world. Today the city''s Black community shares space with a rapidly growing Latino population.'),
  ('portland','Portland','The Albina neighborhood in North Portland was once a thriving Black community before urban renewal displaced thousands — the community is still here, still building.','Portland has a complex racial history — Oregon was the only state to enter the Union with a law excluding Black people from living there. Despite this, Black Portlanders built a vibrant community in Albina during the Great Migration. Today the city''s Black community is working to reclaim cultural and economic space while a growing East African and Latino community adds new vitality.')
