...
export async function ensureLibraryEvidenceBatchB(
  ...
  try {
    ...
    // IPAWS — the authoritative reference for how Wireless Emergency Alerts are issued.
    // MWM must always direct members to official alerting authorities; this source grounds that requirement.
    await add("Emergency Preparedness","authoritative","FEMA — Wireless Emergency Alerts (IPAWS)","https://www.fema.gov/emergency-managers/practitioners/integrated-public-alert-warning-system/public/wireless-emergency-alerts","FEMA's Integrated Public Alert & Warning System (IPAWS) describes how Wireless Emergency Alerts are issued exclusively by authorized public alerting authorities — federal, state, local, tribal, and territorial agencies. MWM uses this as the governing reference for all in-app safety alert language and always directs members to the named official authority.",false);
    ...
    await add("Neighborhood Safety","authoritative","DOJ — Community Programs","https://www.justice.gov/ovcs","DOJ's Office for Victims of Crime supports violence intervention, crime victim services, and community-police trust-building initiatives in high-violence neighborhoods.",false);
