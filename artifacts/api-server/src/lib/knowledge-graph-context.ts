...
const TOPIC_INTENT_PATTERNS: Array<{ topic_name: string; keywords: string[] }> = [
  ...
  // ── Education ──────────────────────────────────────────────────────────────
  { topic_name: "HBCUs", keywords: ["hbcu", "historically black college", "historically black university", "black college", "black university", "hbcus"] },
  { topic_name: "HBCU Admissions & Scholarships", keywords: ["hbcu admission", "apply to hbcu", "hbcu scholarship", "hbcu financial aid", "get into hbcu", "hbcu application"] },
  { topic_name: "FAFSA & Financial Aid Navigation", keywords: ["fafsa", "financial aid", "pell grant", "student aid", "college funding", "pay for college", "college cost", "expected family contribution"] },
  { topic_name: "First-Generation College Students", keywords: ["first generation", "first gen", "first in family", "first to go to college", "first-gen student", "trio program", "upward bound"] },
  // ── Health ─────────────────────────────────────────────────────────────────
  { topic_name: "Diabetes", keywords: ["diabetes", "diabetic", "blood sugar", "insulin", "type 2", "type 1", "a1c", "glucose"] },
  { topic_name: "Maternal Health", keywords: ["maternal health", "pregnancy", "prenatal", "postpartum", "maternal mortality", "black maternal", "birthing", "doula", "midwife", "obstetrics"] },
  { topic_name: "Mental Health", keywords: ["mental health", "therapy", "therapist", "depression", "anxiety", "trauma", "ptsd", "counseling", "psychiatrist", "emotional", "healing", "burnout"] },
  { topic_name: "Fertility", keywords: ["fertility", "trying to conceive", "ttc", "infertility", "fertility treatment", "reproductive health", "ivf", "iui"] },
  { topic_name: "IVF", keywords: ["ivf", "in vitro", "ivf treatment", "embryo transfer", "egg retrieval", "fertility clinic"] },
  { topic_name: "Fibroids", keywords: ["fibroids", "uterine fibroids", "fibroid", "myomectomy", "hysterectomy", "fibroid pain"] },
  { topic_name: "Endometriosis", keywords: ["endometriosis", "endo", "endometriosis pain", "adenomyosis", "pelvic pain", "endometriosis diagnosis"] },
  { topic_name: "Sickle Cell Disease", keywords: ["sickle cell", "sickle cell disease", "scd", "sickle cell anemia", "sickle cell trait"] },
  { topic_name: "Breast Cancer", keywords: ["breast cancer", "mammogram", "triple negative", "breast cancer screening", "cancer diagnosis", "breast health"] },
  { topic_name: "Prostate Health", keywords: ["prostate", "prostate cancer", "prostate screening", "psa test", "prostate health"] },
  { topic_name: "Hypertension", keywords: ["hypertension", "high blood pressure", "blood pressure", "cardiovascular", "heart disease", "stroke risk"] },
  { topic_name: "Menopause", keywords: ["menopause", "perimenopause", "hot flashes", "menopause symptoms", "hormone", "hrt"] },
  { topic_name: "PCOS", keywords: ["pcos", "polycystic ovary", "polycystic ovarian syndrome", "hormone imbalance", "irregular periods"] },
  // ── Divine Nine ────────────────────────────────────────────────────────────
  { topic_name: "Alpha Kappa Alpha", keywords: ["alpha kappa alpha", "aka", "aka sorority", "1908", "pink and green", "ivy"] },
  { topic_name: "Alpha Phi Alpha", keywords: ["alpha phi alpha", "apa", "alpha phi alpha fraternity", "1906", "cornell", "sphinx"] },
  { topic_name: "Kappa Alpha Psi", keywords: ["kappa alpha psi", "kappa", "nupe", "1911", "krimson and kream"] },
  { topic_name: "Omega Psi Phi", keywords: ["omega psi phi", "que", "1911", "omega", "ques", "omega fraternity"] },
  { topic_name: "Delta Sigma Theta", keywords: ["delta sigma theta", "dst", "delta", "1913", "crimson and cream", "deltas"] },
  { topic_name: "Phi Beta Sigma", keywords: ["phi beta sigma", "sigma", "pbs", "1914", "blue and white", "sigmas"] },
  { topic_name: "Zeta Phi Beta", keywords: ["zeta phi beta", "zeta", "zpb", "1920", "blue and white", "zetas"] },
  { topic_name: "Sigma Gamma Rho", keywords: ["sigma gamma rho", "sgr", "sgrho", "1922", "royal blue and gold"] },
  { topic_name: "Iota Phi Theta", keywords: ["iota phi theta", "iota", "ipt", "1963", "brown and gold", "iotas"] },
  // ── Faith ──────────────────────────────────────────────────────────────────
  { topic_name: "African Methodist Episcopal", keywords: ["ame church", "ame", "african methodist episcopal", "methodist", "richard allen", "mother bethel"] },
  { topic_name: "Baptist", keywords: ["baptist", "black baptist", "national baptist", "baptist church", "baptist convention"] },
  { topic_name: "Church of God in Christ", keywords: ["cogic", "church of god in christ", "pentecostal", "charles mason", "bishop mason"] },
  { topic_name: "Black Catholic", keywords: ["black catholic", "african american catholic", "black catholics", "historically black catholic"] },
  { topic_name: "Ethiopian Orthodox", keywords: ["ethiopian orthodox", "tewahedo", "ge'ez", "coptic", "haile selassie", "rastafari"] },
  { topic_name: "Islam", keywords: ["islam", "muslim", "mosque", "nation of islam", "sunni", "shia", "quran", "islamic", "malcolm x"] },
  { topic_name: "Judaism", keywords: ["judaism", "jewish", "hebrew israelite", "beta israel", "ethiopian jewish", "black jewish"] },
  { topic_name: "African & Diaspora Spirituality", keywords: ["yoruba", "vodou", "voodoo", "candomble", "santeria", "ifa", "orisha", "african spirituality", "diaspora spirituality"] },
  // ── International Travel ───────────────────────────────────────────────────
  { topic_name: "Thailand", keywords: ["thailand", "thai", "thai culture", "visit thailand", "traveling to thailand"] },
  { topic_name: "Bangkok", keywords: ["bangkok", "bkk", "wat phra kaew", "chatuchak", "floating market", "khao san road"] },
  { topic_name: "Phuket", keywords: ["phuket", "phuket island", "phi phi", "patong", "old phuket town", "andaman sea"] },
  { topic_name: "Kenya", keywords: ["kenya", "nairobi", "maasai mara", "safari", "mombasa", "kenyan"] },
  { topic_name: "Ethiopia", keywords: ["ethiopia", "lalibela", "addis ababa", "habesha", "ethiopian culture", "ethiopian food"] },
  { topic_name: "Ghana", keywords: ["ghana", "accra", "cape coast", "year of return", "ghana travel", "kumasi", "ashanti"] },
  { topic_name: "Nigeria", keywords: ["nigeria", "lagos", "abuja", "naija", "nigerian culture", "yoruba", "igbo", "nollywood"] },
  { topic_name: "South Africa", keywords: ["south africa", "cape town", "johannesburg", "soweto", "robben island", "kruger", "mandela", "joburg"] },
  { topic_name: "Jamaica", keywords: ["jamaica", "kingston", "montego bay", "negril", "reggae", "jamaican", "dancehall", "rastafari"] },
  { topic_name: "Haiti", keywords: ["haiti", "haitian", "port-au-prince", "citadelle", "creole", "haitian culture", "haiti travel"] },
  { topic_name: "Brazil", keywords: ["brazil", "salvador bahia", "afro-brazilian", "candomble", "capoeira", "carnival brazil"] },
  { topic_name: "Colombia", keywords: ["colombia", "cartagena", "afro-colombian", "medellin", "bogota", "barranquilla"] },
];
