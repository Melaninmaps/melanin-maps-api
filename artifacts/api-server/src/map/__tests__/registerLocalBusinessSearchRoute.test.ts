...
describe("local business search route", () => {
  ...
  it.each([
    ...
    ["hexadecimal latitude", "subject=bookstore&lat=0x10&lng=-75&radius=5"],
    ["binary latitude", "subject=bookstore&lat=0b10&lng=-75&radius=5"],
    ["exponent latitude", "subject=bookstore&lat=3.9e1&lng=-75&radius=5"],
    ["junk-suffixed longitude", "subject=bookstore&lat=39&lng=-75west&radius=5"],
