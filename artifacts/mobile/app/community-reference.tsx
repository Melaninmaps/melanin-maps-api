          ...
          {step === 1 ? (
            ...
            <>
              ...
              <Text style={[s.footerNote, { color: colors.mutedForeground }]}>
                By submitting, you confirm this is a good-faith community recommendation. This listing will appear in search results with a clear "Community Reference" designation and will never be promoted or featured alongside Black-owned businesses.
              </Text>
            </>
          )}
        </ScrollView>
