...
const MOCK_LISTS: CommunityList[] = [
  { id: 1, title: "Black-Owned Brunch Spots in Chicago", description: "The city's best Sunday brunch — all minority-owned, all worth the wait.", category: "Food", coverEmoji: "🥞", savedCount: 234, createdAt: new Date(Date.now() - 86400000 * 2).toISOString(), authorFirstName: "Tasha", authorLastName: "R." },
  { id: 2, title: "Date-Night Restaurants in Philadelphia", description: "Upscale, intimate, and 100% minority-owned. Perfect for any occasion.", category: "Food", coverEmoji: "🕯️", savedCount: 187, createdAt: new Date(Date.now() - 86400000 * 5).toISOString(), authorFirstName: "Jordan", authorLastName: "M." },
