...
const MOCK_LISTS: CommunityList[] = [
  { id: 1, title: "Minority-Owned Brunch Spots in Chicago", description: "The city's best Sunday brunch — all minority-owned, all worth the wait.", category: "Food", coverEmoji: "🥞", savedCount: 234, createdAt: new Date(Date.now() - 86400000 * 2).toISOString(), authorFirstName: "Tasha", authorLastName: "R." },
  { id: 2, title: "Date-Night Restaurants in Charlotte", description: "Upscale, intimate, and 100% minority-owned. Perfect for any occasion.", category: "Food", coverEmoji: "🕯️", savedCount: 187, createdAt: new Date(Date.now() - 86400000 * 5).toISOString(), authorFirstName: "Jordan", authorLastName: "M." },
  { id: 3, title: "Best Minority-Owned Bookstores", description: "From Harlem to Houston — independent Black bookstores worth every mile.", category: "Culture", coverEmoji: "📚", savedCount: 412, createdAt: new Date(Date.now() - 86400000 * 9).toISOString(), authorFirstName: "Amara", authorLastName: "B." },
  { id: 4, title: "Family-Friendly Places in Orlando", description: "Kid-approved, parent-loved minority-owned spots near the parks and beyond.", category: "Family", coverEmoji: "👨🏾‍👩🏾‍👧🏾", savedCount: 156, createdAt: new Date(Date.now() - 86400000 * 14).toISOString(), authorFirstName: "Darius", authorLastName: "W." },
  ...
  { id: 6, title: "Minority-Owned Coffee Shops Nationwide", description: "Your work-from-café guide — great Wi-Fi, great vibes, great owners.", category: "Food", coverEmoji: "☕", savedCount: 298, createdAt: new Date(Date.now() - 86400000 * 25).toISOString(), authorFirstName: "Marcus", authorLastName: "T." },
