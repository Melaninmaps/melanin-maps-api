...
const MOCK_LISTS: CommunityList[] = [
  ...
  { id: 2, title: "Date-Night Restaurants in Philadelphia", description: "Upscale, intimate, and 100% Black-owned. Perfect for any occasion.", category: "Food", coverEmoji: "🕯️", savedCount: 187, createdAt: new Date(Date.now() - 86400000 * 5).toISOString(), authorFirstName: "Jordan", authorLastName: "M." },
