...
const MOCK_CHALLENGES: Challenge[] = [
  {
    ...
    description: "Dine at 3 Black-owned restaurants this week. Leave a review at each. Earn double points on every check-in.",
    endsIn: "5 days",
    participants: 1240,
    points: 300,
    color: "#C9922B",
  ...
  },
  {
    ...
    description: "Every Saturday this month: check in at a local Black-owned business. Earn a streak badge for 4 consecutive Saturdays.",
    endsIn: "26 days",
    participants: 892,
    points: 250,
    color: "#2D7A4F",
  ...
  },
  {
    ...
    description: "Build a community list of your top Black-owned gift picks. Lists with 5+ businesses earn a featured spot.",
    endsIn: "45 days",
    participants: 567,
    points: 200,
    color: "#DC2626",
