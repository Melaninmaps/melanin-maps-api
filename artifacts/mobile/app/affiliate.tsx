...
const DEALS: Deal[] = [
  {
    ...
    detail: "Exclusive rates on 28M+ properties worldwide — curated to put you near Black-owned businesses.",
  ...
  },
  {
    ...
    detail: "Stay in Black-owned properties and support community hosts. Credit applied to first qualifying booking.",
