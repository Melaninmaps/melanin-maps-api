...
const SLIDES = [
  ...
  },
  {
    ...
    gradientTo: "#1C0E06ee",
    eyebrow: "COMMUNITY-POWERED INTEL",
    title: "Know Before\nYou Go.",
    titleItalic: "Always.",
    subtitle: "Real safety reports from people who look like you. No guessing, no gatekeeping.",
  },
  {
    id: "travel",
  ...
  },
  {
    ...
    gradientTo: "#1C0E06ee",
    eyebrow: "10K+ MEMBERS & GROWING",
    title: "Join the",
    titleItalic: "Movement.",
    subtitle: "Map culture, safety, and Black excellence nationwide — with a community that has your back.",
  },
];
