...
const CONSUMER_PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Save up to 10 employers",
      "Save up to 25 locations",
      "Basic push alerts",
      "Basic safety alerts",
  ...
  },
  {
    ...
    features: [
      ...
      "Save up to 100 employers",
      "Save up to 250 locations",
      "Custom push alerts",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited saved employers & locations",
