...
const styles = StyleSheet.create({
  ...
  inputRow: { flexDirection: "row", alignItems: "center", borderWidth: 1, borderRadius: 12, paddingHorizontal: 14, minHeight: 52, gap: 8 },
  inputFlat: { flex: 1, fontSize: 17, fontFamily: "Inter_400Regular", padding: 0 },
