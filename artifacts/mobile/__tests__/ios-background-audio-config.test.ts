...
describe("iOS App Review background-audio configuration", () => {
  it("uses identifiers above every recorded submitted or reserved artifact", () => {
    ...
    // reviewed source's exact 124/94 identifiers before a build is allowed.
    ...
    expect(appJson.expo.ios.buildNumber).toBe("124");
    expect(appJson.expo.android.versionCode).toBe(94);
