export default function BizSlide07Dashboard() {
  const metrics = [
    {
      label: "Profile Views",
      value: "2,847",
    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#FAF6EF" }}>
      ...
      <div className="absolute left-[6vw] right-[6vw] top-[3.5vw]">
        ...
        <div className="font-display" style={{ fontSize: "3.2vw", fontWeight: 800, color: "#1C0E06", lineHeight: 1.08 }}>
          ...
          <span style={{ color: "#CA922B" }}>before your competitors do.</span>
        </div>
      </div>

      <div className="absolute" style={{ left: "6vw", right: "6vw", top: "15vw", height: "1px", background: "rgba(202,146,43,0.2)" }} />

      {/* Dashboard — browser chrome mockup */}
      <div className="absolute" style={{ left: "6vw", right: "6vw", top: "16.5vw", bottom: "5.5vw", background: "#FFFFFF", borderRadius: "1vw", border: "1px solid rgba(58,31,14,0.1)", overflow: "hidden", boxShadow: "0 0.3vw 1.5vw rgba(58,31,14,0.08)" }}>
        ...
        <div style={{ background: "#F5EBD8", padding: "0.6vw 1vw", display: "flex", alignItems: "center", gap: "0.5vw", borderBottom: "1px solid rgba(58,31,14,0.08)" }}>
          <div style={{ display: "flex", gap: "0.3vw" }}>
            <div style={{ width: "0.55vw", height: "0.55vw", borderRadius: "50%", background: "rgba(58,31,14,0.2)" }} />
            <div style={{ width: "0.55vw", height: "0.55vw", borderRadius: "50%", background: "rgba(58,31,14,0.2)" }} />
            <div style={{ width: "0.55vw", height: "0.55vw", borderRadius: "50%", background: "rgba(58,31,14,0.2)" }} />
          </div>
        ...
        <div style={{ padding: "1.2vw 1.5vw" }}>
            ...
            {metrics.map((m, i) => (
              <div key={i} style={{ background: "#FAF6EF", borderRadius: "0.7vw", padding: "1vw 1.1vw", border: "1px solid rgba(58,31,14,0.07)" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "0.5vw" }}>
                  ...
                  <svg width="1vw" height="1vw" viewBox="0 0 24 24" fill="none" stroke="#CA922B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    {m.icon}
                  </svg>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.3vw" }}>
                  {m.up && (
                    <svg width="0.7vw" height="0.7vw" viewBox="0 0 24 24" fill="none" stroke="#5A9A6F" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ marginTop: "0.9vw", background: "linear-gradient(135deg, #3D2417, #1C0E06)", borderRadius: "0.7vw", padding: "0.8vw 1.2vw", display: "flex", alignItems: "center", gap: "1vw" }}>
            <svg width="1.2vw" height="1.2vw" viewBox="0 0 24 24" fill="none" stroke="#CA922B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
            </svg>
            <span className="font-body" style={{ fontSize: "0.78vw", color: "#CA922B", fontWeight: 700 }}>KinfolkAI™:</span>
            <span className="font-body" style={{ fontSize: "0.78vw", color: "#D9C4A3" }}>You have 218 saves this month. Now is the perfect time to run a promotion — ready to draft one?</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-[6vw] right-[6vw] bottom-[1.5vw]">
        <div className="font-display" style={{ fontSize: "1.05vw", fontWeight: 700, color: "#CA922B", fontStyle: "italic" }}>
          Data your competitors don't have. Decisions only you can make.
        </div>
      </div>
    </div>
  );
