export default function BizSlide06Flywheel() {
    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#3D2417" }}>
      ...
      <div className="absolute" style={{ left: "3vw", top: "14vw", width: "46vw", height: "46vw" }}>
        <svg viewBox="0 0 420 420" width="100%" height="100%">
          ...
          {/* Arc segments with arrows (clockwise, 60° each, drawn from +12° to +48° of each segment) */}
          {nodes.map((node, i) => {
      ...
      {/* Right — 4 benefit blocks */}
      <div className="absolute right-[5vw] flex flex-col justify-center" style={{ left: "52vw", top: "14vw", bottom: "8vw", gap: "0" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "2.2vw" }}>
          {[
            {
              label: "Community Recommendations",
              body: "Recommendations become discovery.",
              icon: <><circle cx="9" cy="7" r="5"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><path d="M21 21v-2a4 4 0 0 0-3-3.87"/></>
            },
            {
              label: "Saves & Favorites",
              body: "Interest becomes future customers.",
              icon: <><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></>
            },
            {
              label: "Reviews",
              body: "Every review strengthens trust.",
              icon: <><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></>
            },
            {
              label: "KinfolkAI™",
              body: "Learns what makes your business successful.",
              icon: <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 8h.01"/><path d="M12 8h.01"/><path d="M17 8h.01"/></>
            },
          ].map((item, i) => (
