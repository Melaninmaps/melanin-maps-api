...
const manifestFile = resolve(root, "review-package/next-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/next-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/next-three-city-combined-destination-health.json");
const concurrency = 6;
