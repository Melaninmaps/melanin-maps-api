...
const manifestFile = resolve(root, "review-package/houston-cumulative-everyday-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/houston-cumulative-everyday-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/houston-cumulative-everyday-combined-destination-health.json");
const concurrency = 6;
