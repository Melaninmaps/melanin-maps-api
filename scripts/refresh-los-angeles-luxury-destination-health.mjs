...
const manifestFile = resolve(root, "review-package/los-angeles-luxury-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/los-angeles-luxury-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/los-angeles-luxury-combined-destination-health.json");
const concurrency = 6;
