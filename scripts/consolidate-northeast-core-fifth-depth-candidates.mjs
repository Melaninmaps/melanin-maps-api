...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-northeast-core-fifth-depth-review");
...
const consolidated = [...recordsByKey.values()]
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      ...notes,
        northeast_core_fifth_depth_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "northeast-core-fifth-depth-consolidated-candidates.jsonl",
    exactDuplicates: "northeast-core-fifth-depth-exact-duplicates-removed.json",
    destinationCollisions: "northeast-core-fifth-depth-destination-collisions-review.json",
    invalidRowsHeld: "northeast-core-fifth-depth-invalid-or-incomplete-rows-held.json",
  },
};
