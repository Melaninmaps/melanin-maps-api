...
const root = resolve(process.argv[2] ?? "data/founder-imports/2026-09-18-mid-atlantic-combined-pass");
const consolidatedDirectory = resolve(root, "consolidated");
const inputManifest = resolve(consolidatedDirectory, "mid-atlantic-consolidated-candidates.jsonl");
const inputHealth = resolve(consolidatedDirectory, "mid-atlantic-combined-destination-health.json");
...
const summary = {
  package: "2026-09-18-mid-atlantic-combined-source-backed-review",
...
const healthPayload = {
  ...
  sourceManifest: "mid-atlantic-combined-review-only-candidates.jsonl",
  candidates: accepted.length,
