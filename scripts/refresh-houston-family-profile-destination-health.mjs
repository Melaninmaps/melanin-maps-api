...
const manifestFile = resolve(root, "review-package/houston-family-profile-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/houston-family-profile-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/houston-family-profile-combined-destination-health.json");
const concurrency = 6;
