...
const manifestFile = resolve(root, "review-package/northeast-core-expansion-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/northeast-core-expansion-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/northeast-core-expansion-combined-destination-health.json");
const concurrency = 6;
