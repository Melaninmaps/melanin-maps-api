...
const manifestFile = resolve(root, "review-package/sixth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/sixth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/sixth-three-city-combined-destination-health.json");
const concurrency = 6;
