...
const manifestFile = resolve(root, "review-package/philly-bucks-sixth-depth-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/philly-bucks-sixth-depth-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/philly-bucks-sixth-depth-combined-destination-health.json");
const concurrency = 6;
