...
const manifestFile = resolve(root, "review-package/international-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/international-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/international-three-city-combined-destination-health.json");
const concurrency = 6;
