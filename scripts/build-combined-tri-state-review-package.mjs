...
const root = resolve(process.argv[2] ?? "data/founder-imports/2026-09-18-tri-state-combined-pass");
const consolidatedDirectory = resolve(root, "consolidated");
const inputManifest = resolve(consolidatedDirectory, "tri-state-consolidated-candidates.jsonl");
const inputHealth = resolve(consolidatedDirectory, "tri-state-combined-destination-health.json");
...
for (const source of sourceRecords) {
  ...
  if (!text(source.city)) reasons.push("missing_city");
...
const summary = {
  package: "2026-09-18-tri-state-combined-source-backed-review",
...
const healthPayload = {
  ...
  sourceManifest: "tri-state-combined-review-only-candidates.jsonl",
  candidates: accepted.length,
