...
const manifestFile = resolve(root, "review-package/fifth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/fifth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/fifth-three-city-combined-destination-health.json");
const concurrency = 6;
