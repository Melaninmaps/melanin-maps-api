...
const manifestFile = resolve(root, "review-package/tenth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/tenth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/tenth-three-city-combined-destination-health.json");
const concurrency = 6;
