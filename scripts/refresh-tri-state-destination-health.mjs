...
const manifestFile = resolve(root, "review-package/tri-state-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/tri-state-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/tri-state-combined-destination-health.json");
const concurrency = 6;
