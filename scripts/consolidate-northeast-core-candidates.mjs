...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-northeast-core-review");
...
const summary = {
  ...
  files: {
    candidates: "northeast-core-consolidated-candidates.jsonl",
    exactDuplicates: "northeast-core-exact-duplicates-removed.json",
    destinationCollisions: "northeast-core-destination-collisions-review.json",
    invalidRowsHeld: "northeast-core-invalid-or-incomplete-rows-held.json",
  },
};
