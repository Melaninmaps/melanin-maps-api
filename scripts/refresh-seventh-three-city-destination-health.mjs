...
const manifestFile = resolve(root, "review-package/seventh-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/seventh-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/seventh-three-city-combined-destination-health.json");
const concurrency = 6;
