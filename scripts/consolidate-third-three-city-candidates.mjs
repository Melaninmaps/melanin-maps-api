...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-third-three-city-review");
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      notes: JSON.stringify({
        ...notes,
        third_three_city_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "third-three-city-consolidated-candidates.jsonl",
    exactDuplicates: "third-three-city-exact-duplicates-removed.json",
    destinationCollisions: "third-three-city-destination-collisions-review.json",
    invalidRowsHeld: "third-three-city-invalid-or-incomplete-rows-held.json",
  },
};
