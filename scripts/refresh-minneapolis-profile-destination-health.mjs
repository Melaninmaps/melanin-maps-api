...
const manifestFile = resolve(root, "review-package/minneapolis-profile-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/minneapolis-profile-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/minneapolis-profile-combined-destination-health.json");
const concurrency = 6;
