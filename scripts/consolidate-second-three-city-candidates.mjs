...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-second-three-city-review");
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      notes: JSON.stringify({
        ...notes,
        second_three_city_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "second-three-city-consolidated-candidates.jsonl",
    exactDuplicates: "second-three-city-exact-duplicates-removed.json",
    destinationCollisions: "second-three-city-destination-collisions-review.json",
    invalidRowsHeld: "second-three-city-invalid-or-incomplete-rows-held.json",
  },
};
