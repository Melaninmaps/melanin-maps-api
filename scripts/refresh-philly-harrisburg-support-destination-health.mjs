...
const manifestFile = resolve(root, "review-package/philly-harrisburg-support-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/philly-harrisburg-support-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/philly-harrisburg-support-combined-destination-health.json");
const concurrency = 6;
