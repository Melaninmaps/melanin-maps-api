...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-northeast-core-expansion-review");
...
const consolidated = [...recordsByKey.values()]
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      ...notes,
        northeast_core_expansion_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "northeast-core-expansion-consolidated-candidates.jsonl",
    exactDuplicates: "northeast-core-expansion-exact-duplicates-removed.json",
    destinationCollisions: "northeast-core-expansion-destination-collisions-review.json",
    invalidRowsHeld: "northeast-core-expansion-invalid-or-incomplete-rows-held.json",
  },
};
