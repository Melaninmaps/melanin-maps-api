...
const manifestFile = resolve(root, "review-package/fourth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/fourth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/fourth-three-city-combined-destination-health.json");
const concurrency = 6;
