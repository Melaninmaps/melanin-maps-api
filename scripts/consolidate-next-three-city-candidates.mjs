...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-next-three-city-review");
...
const summary = {
  ...
  files: {
    candidates: "next-three-city-consolidated-candidates.jsonl",
    exactDuplicates: "next-three-city-exact-duplicates-removed.json",
    destinationCollisions: "next-three-city-destination-collisions-review.json",
    invalidRowsHeld: "next-three-city-invalid-or-incomplete-rows-held.json",
  },
};
