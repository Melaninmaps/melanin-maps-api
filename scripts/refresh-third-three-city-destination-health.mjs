...
const manifestFile = resolve(root, "review-package/third-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/third-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/third-three-city-combined-destination-health.json");
const concurrency = 6;
