...
const manifestFile = resolve(root, "review-package/northeast-core-depth-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/northeast-core-depth-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/northeast-core-depth-combined-destination-health.json");
const concurrency = 6;
