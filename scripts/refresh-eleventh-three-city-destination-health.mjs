...
const manifestFile = resolve(root, "review-package/eleventh-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/eleventh-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/eleventh-three-city-combined-destination-health.json");
const concurrency = 6;
