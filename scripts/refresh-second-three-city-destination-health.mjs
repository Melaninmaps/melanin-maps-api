...
const manifestFile = resolve(root, "review-package/second-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/second-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/second-three-city-combined-destination-health.json");
const concurrency = 6;
