...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-northeast-core-launch-review");
...
const consolidated = [...recordsByKey.values()]
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      ...notes,
        northeast_core_launch_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "northeast-core-launch-consolidated-candidates.jsonl",
    exactDuplicates: "northeast-core-launch-exact-duplicates-removed.json",
    destinationCollisions: "northeast-core-launch-destination-collisions-review.json",
    invalidRowsHeld: "northeast-core-launch-invalid-or-incomplete-rows-held.json",
  },
};
