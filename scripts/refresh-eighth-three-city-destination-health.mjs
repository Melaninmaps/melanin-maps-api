...
const manifestFile = resolve(root, "review-package/eighth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/eighth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/eighth-three-city-combined-destination-health.json");
const concurrency = 6;
