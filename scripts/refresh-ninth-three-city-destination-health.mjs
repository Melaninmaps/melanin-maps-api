...
const manifestFile = resolve(root, "review-package/ninth-three-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/ninth-three-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/ninth-three-city-combined-destination-health.json");
const concurrency = 6;
