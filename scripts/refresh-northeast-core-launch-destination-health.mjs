...
const manifestFile = resolve(root, "review-package/northeast-core-launch-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/northeast-core-launch-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/northeast-core-launch-combined-destination-health.json");
const concurrency = 6;
