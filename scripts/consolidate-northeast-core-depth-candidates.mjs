...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-northeast-core-depth-review");
...
const consolidated = [...recordsByKey.values()]
  ...
  .map((item, index) => {
    ...
    const record = {
      ...
      ...notes,
        northeast_core_depth_consolidation: {
...
const summary = {
  ...
  files: {
    candidates: "northeast-core-depth-consolidated-candidates.jsonl",
    exactDuplicates: "northeast-core-depth-exact-duplicates-removed.json",
    destinationCollisions: "northeast-core-depth-destination-collisions-review.json",
    invalidRowsHeld: "northeast-core-depth-invalid-or-incomplete-rows-held.json",
  },
};
