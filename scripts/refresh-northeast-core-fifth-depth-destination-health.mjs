...
const manifestFile = resolve(root, "review-package/northeast-core-fifth-depth-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/northeast-core-fifth-depth-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/northeast-core-fifth-depth-combined-destination-health.json");
const concurrency = 6;
