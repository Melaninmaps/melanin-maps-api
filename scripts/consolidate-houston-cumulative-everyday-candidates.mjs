...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-19-houston-cumulative-everyday-review");
...
const summary = {
  ...
  files: {
    candidates: "houston-cumulative-everyday-consolidated-candidates.jsonl",
    exactDuplicates: "houston-cumulative-everyday-exact-duplicates-removed.json",
    destinationCollisions: "houston-cumulative-everyday-destination-collisions-review.json",
    invalidRowsHeld: "houston-cumulative-everyday-invalid-or-incomplete-rows-held.json",
  },
};
