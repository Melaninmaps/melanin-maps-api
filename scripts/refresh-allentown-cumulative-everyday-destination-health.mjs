...
const manifestFile = resolve(root, "review-package/allentown-cumulative-everyday-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/allentown-cumulative-everyday-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/allentown-cumulative-everyday-combined-destination-health.json");
const concurrency = 6;
