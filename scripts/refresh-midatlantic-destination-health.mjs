...
const manifestFile = resolve(root, "review-package/mid-atlantic-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/mid-atlantic-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/mid-atlantic-combined-destination-health.json");
const concurrency = 6;
