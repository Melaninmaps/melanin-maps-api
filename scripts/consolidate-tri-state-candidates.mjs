...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-18-tri-state-verified-sweep");
...
const summary = {
  ...
  files: {
    candidates: "tri-state-consolidated-candidates.jsonl",
    exactDuplicates: "tri-state-exact-duplicates-removed.json",
    destinationCollisions: "tri-state-destination-collisions-review.json",
    invalidRowsHeld: "tri-state-invalid-or-incomplete-rows-held.json",
  },
};
