...
const root = resolve(process.argv[2] ?? "/home/ubuntu/melanin-maps-inventory-staging/data/founder-imports/2026-09-19-los-angeles-luxury-review");
...
const summary = {
  ...
  files: {
    candidates: "los-angeles-luxury-consolidated-candidates.jsonl",
    exactDuplicates: "los-angeles-luxury-exact-duplicates-removed.json",
    destinationCollisions: "los-angeles-luxury-destination-collisions-review.json",
    invalidRowsHeld: "los-angeles-luxury-invalid-or-incomplete-rows-held.json",
  },
};
