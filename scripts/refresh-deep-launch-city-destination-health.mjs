...
const manifestFile = resolve(root, "review-package/deep-launch-city-combined-review-only-candidates.jsonl");
const healthFile = resolve(root, "consolidated/deep-launch-city-combined-destination-health.json");
const outputFile = resolve(root, "consolidated/deep-launch-city-combined-destination-health.json");
const concurrency = 6;
