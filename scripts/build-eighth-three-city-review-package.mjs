...
const root = resolve(process.argv[2] ?? "data/founder-imports/2026-09-18-eighth-three-city-review");
const consolidatedDirectory = resolve(root, "consolidated");
const inputManifest = resolve(consolidatedDirectory, "eighth-three-city-consolidated-candidates.jsonl");
const inputHealth = resolve(consolidatedDirectory, "eighth-three-city-combined-destination-health.json");
...
const summary = {
  package: "2026-09-18-eighth-three-city-combined-source-backed-review",
...
const healthPayload = {
  ...
  sourceManifest: "eighth-three-city-combined-review-only-candidates.jsonl",
  candidates: accepted.length,
