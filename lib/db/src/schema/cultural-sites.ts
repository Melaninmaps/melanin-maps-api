...
export const culturalSitesTable = pgTable("cultural_sites", {
  ...
  culturalCommunity: varchar("cultural_community", { length: 100 }),
  visitTip: text("visit_tip"),
  contentNote: text("content_note"),
  pinType: varchar("pin_type", { length: 100 }),
  listingStatus: varchar("listing_status", { length: 50 }).default("staged"),
  approximateLocation: boolean("approximate_location").default(false),
