export declare const kinfolkSearchEventsTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "kinfolk_search_events";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "kinfolk_search_events";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=kinfolk-search-events.d.ts.map