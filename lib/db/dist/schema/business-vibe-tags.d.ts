export declare const businessVibeTagsTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "business_vibe_tags";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "business_vibe_tags";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
...
//# sourceMappingURL=business-vibe-tags.d.ts.map