 ...
 */
export declare const safetyCheckinRecipientsTable: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "safety_checkin_recipients";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "safety_checkin_recipients";
            dataType: "string";
            columnType: "PgVarchar";
            data: string;
            driverParam: string;
        ...
        checkinId: import("drizzle-orm/pg-core").PgColumn<{
            name: "checkin_id";
            tableName: "safety_checkin_recipients";
            dataType: "number";
        ...
        trustedShareId: import("drizzle-orm/pg-core").PgColumn<{
            name: "trusted_share_id";
            tableName: "safety_checkin_recipients";
            dataType: "string";
            columnType: "PgVarchar";
            data: string;
        ...
        deliveryStatus: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgVarchar";
            data: "pending" | "delivered" | "skipped";
            driverParam: string;
            notNull: true;
            hasDefault: true;
            isPrimaryKey: false;
            isAutoincrement: false;
            hasRuntimeDefault: false;
            enumValues: ["pending", "delivered", "skipped"];
            baseColumn: never;
            identity: undefined;
            generated: undefined;
        }, {}, {
